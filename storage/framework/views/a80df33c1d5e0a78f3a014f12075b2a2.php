...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.cms.exact-mirror-page','data' => ['page' => $page,'wrapperClass' => 'ctm-live-mirror']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['page' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($page),'wrapperClass' => 'ctm-live-mirror']); ?>
...
<?php endif; ?>
<?php /**PATH D:\Personal Work\AAPSCM-LARAVEL\resources\views\cms\page\cert-ctm-2.blade.php ENDPATH**/ ?>