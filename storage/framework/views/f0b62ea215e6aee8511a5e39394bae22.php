...
<div class="bg-[#0B2F5E] text-white py-16">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col lg:flex-row items-start lg:items-center gap-8">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($certification->og_image || $certification->badge_image): ?>
                <div class="shrink-0">
                    <img src="<?php echo e(asset('storage/' . ($certification->og_image ?? $certification->badge_image))); ?>"
            ...
            <div class="flex-1">
                ...
                <h1 class="text-3xl lg:text-4xl font-bold leading-tight mb-2">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($certification->acronym): ?>
                        <span class="text-white/60 text-2xl font-normal ml-2">(<?php echo e($certification->acronym); ?>)</span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </h1>

                
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($certification->certifying_body): ?>
                    <p class="text-white/70 text-sm mt-1">
                        Offered by <span class="font-semibold text-white"><?php echo e($certification->certifying_body); ?></span>
                    </p>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php /**PATH D:\Personal Work\AAPSCM-LARAVEL\resources\views/components/certification/hero.blade.php ENDPATH**/ ?>