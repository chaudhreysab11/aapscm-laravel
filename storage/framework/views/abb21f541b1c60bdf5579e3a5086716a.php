...
<?php endif; ?>
    ...
    <?php $__env->startPush('body-class'); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($elementorPageId !== ''): ?> elementor-page-<?php echo e($elementorPageId); ?> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <?php $__env->stopPush(); ?>

    <?php $__env->startPush('head'); ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $externalCssFiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $href): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $cssFiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cssFile): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <link rel="stylesheet" href="<?php echo e(asset($cssFile)); ?>">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($inlineCss !== ''): ?>
            <style>
                <?php echo $inlineCss; ?>
        ...
        <style>
            .<?php echo e($wrapperClass); ?> {
                position: relative;
                z-index: 0;
                isolation: isolate;
            }

            .<?php echo e($wrapperClass); ?> > .eltdf-container,
            .<?php echo e($wrapperClass); ?> > .eltdf-container > .eltdf-container-inner,
            .<?php echo e($wrapperClass); ?> > .eltdf-container > .eltdf-container-inner > .eltdf-grid-row,
            .<?php echo e($wrapperClass); ?> > .eltdf-container > .eltdf-container-inner > .eltdf-grid-row > .eltdf-page-content-holder {
                width: 100%;
                max-width: none;
            }
            ...
            .<?php echo e($wrapperClass); ?> .elementor-icon-list-text > a,
            .<?php echo e($wrapperClass); ?> .elementor-icon-list-item a {
                color: inherit !important;
            }

            .<?php echo e($wrapperClass); ?> .elementor-widget-nav-menu .menu-item-has-children {
                position: relative;
            }

            .<?php echo e($wrapperClass); ?> .elementor-widget-nav-menu .menu-item-has-children > a {
                padding-right: 2.75rem;
            }

            .<?php echo e($wrapperClass); ?> .elementor-widget-nav-menu .mirror-nav-toggle {
                position: absolute;
                top: 0.35rem;
                right: 0;
                width: 2rem;
            ...
            .<?php echo e($wrapperClass); ?> .elementor-widget-nav-menu .mirror-nav-toggle:focus-visible {
                outline: 2px solid currentColor;
                outline-offset: 2px;
            }

            .<?php echo e($wrapperClass); ?> .elementor-widget-nav-menu .sub-menu.elementor-nav-menu--dropdown[hidden] {
                display: none !important;
            }

            .<?php echo e($wrapperClass); ?> .elementor-accordion .elementor-tab-content,
            .<?php echo e($wrapperClass); ?> .elementor-toggle .elementor-tab-content {
                display: none;
            }

            .<?php echo e($wrapperClass); ?> .elementor-accordion .elementor-tab-content.elementor-active,
            .<?php echo e($wrapperClass); ?> .elementor-toggle .elementor-tab-content.elementor-active {
                display: block;
            }

            .<?php echo e($wrapperClass); ?> .uael-faq-accordion .uael-accordion-content {
                display: none;
            }

            .<?php echo e($wrapperClass); ?> .uael-faq-accordion .uael-accordion-content.mirror-accordion-active {
                display: block;
            }

            .<?php echo e($wrapperClass); ?> .uael-accordion-title[aria-expanded="true"] .uael-accordion-icon-opened {
                display: inline-flex;
            }

            .<?php echo e($wrapperClass); ?> .uael-accordion-title[aria-expanded="true"] .uael-accordion-icon-closed {
                display: none;
            }

            .<?php echo e($wrapperClass); ?> .uael-accordion-title[aria-expanded="false"] .uael-accordion-icon-opened {
                display: none;
            }

            .<?php echo e($wrapperClass); ?> .uael-accordion-title[aria-expanded="false"] .uael-accordion-icon-closed {
                display: inline-flex;
            }

            .<?php echo e($wrapperClass); ?> .custom_variation > div {
                display: flex;
                width: 100%;
                justify-content: center;
                align-items: center;
            ...
            .<?php echo e($wrapperClass); ?> .custom_variation .label {
            ...
            .<?php echo e($wrapperClass); ?> .custom_variation .value {
                justify-content: center;
            }


            .<?php echo e($wrapperClass); ?> .custom_variation .value select {
                width: 100%;
            }

            .<?php echo e($wrapperClass); ?> .custom_variation .single_add_to_cart_button.button.alt {
                display: inline-flex;
                width: 200px;
                height: 60px;
                align-items: center;
            ...
            .<?php echo e($wrapperClass); ?> .custom_variation .single_add_to_cart_button.button.alt:hover,
            .<?php echo e($wrapperClass); ?> .custom_variation .single_add_to_cart_button.button.alt:focus-visible {
                background: #0b2f8c;
                color: #fff !important;
            }
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            (() => {
                const wrapperSelector = '.<?php echo e($wrapperClass); ?>';
                const popupVideoMap = <?php echo json_encode($elementorPopupVideoMap, 15, 512) ?>;
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($titleHolder): ?>
        <?php
        ...
        <div class="<?php echo e($titleHolderClasses); ?>" style="<?php echo e($titleHolderStyle); ?>" data-height="<?php echo e($titleHolderHeight); ?>">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($titleHolderImage): ?>
                <div class="eltdf-title-image">
                    <img itemprop="image" src="<?php echo e($titleHolderImage); ?>" alt="<?php echo e($titleHolderImageAlt); ?>">
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <div class="eltdf-title-wrapper">
                <div class="eltdf-title-inner">
                    <div class="eltdf-grid">
                        <h2 class="eltdf-page-title entry-title" style="color: <?php echo e($titleHolderTextColor); ?>"><?php echo e($titleHolderText); ?></h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success') || session('error') || $errors->any()): ?>
            <div class="max-w-[1140px] mx-auto px-4 py-6">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('error')): ?>
                    <div class="rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-800 <?php if(session('success')): ?> mt-4 <?php endif; ?>">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($errors->any()): ?>
                    <div class="rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-800 <?php if(session('success') || session('error')): ?> mt-4 <?php endif; ?>">
            ...
            <div class="eltdf-container-inner clearfix">
                <div class="eltdf-grid-row eltdf-grid-medium-gutter">
                    <div class="eltdf-page-content-holder eltdf-grid-col-12">
                        <<?php echo e($root['tag'] ?? 'div'); ?>

                            class="<?php echo e($root['class'] ?? 'elementor'); ?>"
                            data-elementor-type="<?php echo e($root['data_elementor_type'] ?? 'wp-page'); ?>"
                            data-elementor-id="<?php echo e($root['data_elementor_id'] ?? ''); ?>"
                        >
                            <?php echo $bodyHtml; ?>
...
<?php endif; ?>
<?php /**PATH D:\Personal Work\AAPSCM-LARAVEL\resources\views\components\cms\exact-mirror-page.blade.php ENDPATH**/ ?>