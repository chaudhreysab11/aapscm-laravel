<div class="bg-white rounded-lg p-6 md:p-7 shadow-[rgba(100,100,111,0.12)_0px_4px_14px_0px] flex flex-col text-center">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! empty($card['items'])): ?>
        <ul class="space-y-3 text-left mb-5">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $card['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $li): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <li class="flex items-start gap-3">
                    <span class="mt-2 inline-block w-2 h-2 rounded-full bg-[#e74c1d] shrink-0"></span>
                    <span class="text-[14.5px] text-gray-700 leading-relaxed"><?php echo e($li); ?></span>
                </li>
...
<?php /**PATH D:\Personal Work\AAPSCM-LARAVEL\resources\views\cms\page\_partials\cscp-icon-list-card.blade.php ENDPATH**/ ?>