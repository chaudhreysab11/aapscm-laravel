...
<section <?php echo e($attributes->merge(['class' => 'rounded-[26px] border border-slate-200 bg-white p-5 shadow-sm md:p-6'])); ?>>
    <div class="flex flex-col gap-4 border-b border-slate-200 pb-4 md:flex-row md:items-end md:justify-between">
        <div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($eyebrow): ?>
                <p class="text-[10px] font-semibold uppercase tracking-[0.18em] text-slate-400"><?php echo e($eyebrow); ?></p>
...
<?php endif; ?>
                ...
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <h2 class="text-[22px] font-semibold leading-tight text-slate-950"><?php echo e($title); ?></h2>
            </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($description): ?>
                <p class="mt-2 text-[12px] font-medium uppercase tracking-[0.14em] text-slate-400"><?php echo e($description); ?></p>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
...
<?php /**PATH D:\Personal Work\AAPSCM-LARAVEL\resources\views\components\member\section-card.blade.php ENDPATH**/ ?>