...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.cms.exact-mirror-page','data' => ['page' => $page,'wrapperClass' => 'aitp-dmp-live-mirror']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['page' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($page),'wrapperClass' => 'aitp-dmp-live-mirror']); ?>
...
<?php endif; ?>
<?php /**PATH D:\Personal Work\AAPSCM-LARAVEL\resources\views\cms\page\cert-certified-ai-enabled-travel-personalization-digital-marketing-professional-aitp-dmp.blade.php ENDPATH**/ ?>