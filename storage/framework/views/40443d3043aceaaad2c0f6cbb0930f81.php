...
<?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! empty($d['product'])): ?>
        <section class="bg-white py-16 md:py-20">
            <div class="max-w-[1100px] mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! empty($d['product']['image'])): ?>
                    <div>
                        <img src="<?php echo e($d['product']['image']); ?>" alt="<?php echo e($d['product']['title']); ?>" class="w-full h-auto rounded-md" loading="lazy">
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <div>
                    <h1 class="text-[22px] md:text-[28px] font-bold text-[#14166e] leading-snug mb-4"><?php echo e($d['product']['title']); ?></h1>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! empty($d['product']['price'])): ?>
                        <p class="text-[22px] md:text-[26px] font-bold text-[#14166e] mb-6"><?php echo e($d['product']['price']); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! empty($d['product']['cta_label'])): ?>
                        <a href="<?php echo e($d['product']['cta_href']); ?>" class="inline-block bg-[#5cb85c] hover:bg-[#4cae4c] text-white font-semibold text-[15px] px-8 py-3 rounded-full transition"><?php echo e($d['product']['cta_label']); ?></a>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! empty($d['product']['category_name'])): ?>
                        <p class="text-[14px] text-gray-600 mt-6">
                            <?php echo e($d['product']['category_label'] ?? 'Category:'); ?>

                            <a href="<?php echo e($d['product']['category_href'] ?? '#'); ?>" class="text-[#14166e] hover:underline"><?php echo e($d['product']['category_name']); ?></a>
                        </p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH D:\Personal Work\AAPSCM-LARAVEL\resources\views/cms/page/cert-chartered-supply-chain-artificial-intelligence-csai.blade.php ENDPATH**/ ?>