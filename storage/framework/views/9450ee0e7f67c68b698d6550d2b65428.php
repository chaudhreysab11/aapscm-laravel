...
<?php endif; ?>
    ...
    <main>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! empty($page->blocks)): ?>
            <?php if (isset($component)) { $__componentOriginalbef818f64a9d916fc761a2292c47d8e6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbef818f64a9d916fc761a2292c47d8e6 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.cms.blocks-renderer','data' => ['blocks' => $page->blocks]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('cms.blocks-renderer'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalbef818f64a9d916fc761a2292c47d8e6)): ?>
<?php $attributes = $__attributesOriginalbef818f64a9d916fc761a2292c47d8e6; ?>
<?php unset($__attributesOriginalbef818f64a9d916fc761a2292c47d8e6); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalbef818f64a9d916fc761a2292c47d8e6)): ?>
<?php $component = $__componentOriginalbef818f64a9d916fc761a2292c47d8e6; ?>
<?php unset($__componentOriginalbef818f64a9d916fc761a2292c47d8e6); ?>
<?php endif; ?>
        <?php else: ?>
            <?php if (isset($component)) { $__componentOriginal0a5d04e8755afe5963a278944075cad4 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal0a5d04e8755afe5963a278944075cad4 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.cms.wp-prose','data' => ['content' => $page->content,'maxWidth' => 'max-w-[900px]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('cms.wp-prose'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['content' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($page->content),'maxWidth' => 'max-w-[900px]']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>

<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal0a5d04e8755afe5963a278944075cad4)): ?>
<?php $attributes = $__attributesOriginal0a5d04e8755afe5963a278944075cad4; ?>
<?php unset($__attributesOriginal0a5d04e8755afe5963a278944075cad4); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal0a5d04e8755afe5963a278944075cad4)): ?>
<?php $component = $__componentOriginal0a5d04e8755afe5963a278944075cad4; ?>
<?php unset($__componentOriginal0a5d04e8755afe5963a278944075cad4); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH D:\Personal Work\AAPSCM-LARAVEL\resources\views\cms\page\legal-full-width.blade.php ENDPATH**/ ?>