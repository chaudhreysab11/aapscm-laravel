...
<?php endif; ?>
                    ...
                    <div class="eltdf-title-info">
                        ...
                        <div class="eltdf-breadcrumbs-info">
                            <div itemprop="breadcrumb" class="eltdf-breadcrumbs" style="color: rgba(255, 255, 255, 0.82); font-size: 13px; line-height: 1.6; text-align: left;">
                                ...
                                <span class="eltdf-current" style="color: #fff;"><?php echo e($page->title); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="bg-[#f6f8fb] py-14">
        <div class="max-w-[900px] mx-auto px-4">
            ...
            <form method="POST" action="<?php echo e(route('fellow-membership-form.submit')); ?>" enctype="multipart/form-data" class="space-y-8 bg-white rounded-xl p-6 md:p-8 shadow-sm">
                <?php echo csrf_field(); ?>
