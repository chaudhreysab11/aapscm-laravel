...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.auth-portal','data' => ['eyebrow' => $isFirstLogin ? 'AAPSCM® First-Time Access' : 'AAPSCM® Account Recovery','title' => $isFirstLogin ? 'Set Your Password' : 'Reset Password','compact' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['eyebrow' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($isFirstLogin ? 'AAPSCM® First-Time Access' : 'AAPSCM® Account Recovery'),'title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($isFirstLogin ? 'Set Your Password' : 'Reset Password'),'compact' => true]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.icon','data' => ['name' => $isFirstLogin ? 'shield' : 'lock','class' => 'h-3.5 w-3.5 text-[#0b2f5e]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($isFirstLogin ? 'shield' : 'lock'),'class' => 'h-3.5 w-3.5 text-[#0b2f5e]']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
            <?php echo $isFirstLogin ? 'First time access, please configure a strong password' : 'Please enter your new password'; ?>

        </div>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! ($isDirectSetup ?? false)): ?>
...
<?php endif; ?>
    ...
    <form method="POST" action="<?php echo e($formAction ?? route('password.store')); ?>" class="mt-8 space-y-6">
        <?php echo csrf_field(); ?>
        ...
        <div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isDirectSetup ?? false): ?>
                ...
                <input id="email" type="email" value="<?php echo e($email ?? ''); ?>" readonly class="<?php echo e($fieldClass); ?> bg-slate-50 text-slate-600" />
            <?php else: ?>
                <input id="email" type="email" name="email" value="<?php echo e(old('email', $email ?? $request->email)); ?>" required autofocus autocomplete="username" class="<?php echo e($fieldClass); ?>" placeholder="you@example.com" />
...
<?php endif; ?>
        ...
        <div>
            ...
            <input id="password" type="password" name="password" required autocomplete="new-password" class="<?php echo e($fieldClass); ?>" placeholder="Create a new password" />
            <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php unset($__componentOriginal56804098dcf376a0e2227cb77b6cd00a); ?>
<?php endif; ?>
                <?php echo e($isFirstLogin ? 'Set Password' : 'Reset Password'); ?>
...
<?php endif; ?>
<?php /**PATH D:\Personal Work\AAPSCM-LARAVEL\resources\views/auth/reset-password.blade.php ENDPATH**/ ?>