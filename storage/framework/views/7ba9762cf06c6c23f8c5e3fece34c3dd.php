...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.cms.exact-mirror-page','data' => ['page' => $page,'wrapperClass' => 'ac-plscm-live-mirror']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['page' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($page),'wrapperClass' => 'ac-plscm-live-mirror']); ?>
...
<?php endif; ?>
<?php /**PATH D:\Personal Work\AAPSCM-LARAVEL\resources\views\cms\page\cert-advanced-certified-procurement-logistics-supply-chain-manager-ac-plscm.blade.php ENDPATH**/ ?>