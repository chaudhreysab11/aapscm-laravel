<x-layouts.cms>
        ...
        <section class="bg-white py-16 md:py-20">
            <div class="max-w-[1200px] mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                ...
                @if (! empty($d['hero']['images']))
                    <div class="@if(count($d['hero']['images']) > 1) grid grid-cols-2 gap-4 @endif">
    ...
    @if (! empty($d['audience']))
        <section class="bg-[#f6f8fb] py-16 md:py-20">
            <div class="max-w-[1200px] mx-auto px-4 @if(!empty($d['audience']['image'])) grid grid-cols-1 md:grid-cols-2 gap-10 items-center @endif">
                ...
                <div>
                    ...
                    @if (! empty($d['audience']['intro']))
                        <p class="text-[15px] md:text-[16px] text-gray-700 leading-relaxed mb-6">{{ $d['audience']['intro'] }}</p>
                    @endif
                    <ul class="@if(empty($d['audience']['image'])) grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-3 @else space-y-3 @endif">
