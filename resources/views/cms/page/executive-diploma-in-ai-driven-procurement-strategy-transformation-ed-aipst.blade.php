<x-layouts.cms>
            ...
            <div class="max-w-[1200px] mx-auto px-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    @foreach ($d['modules']['cards'] as $c)
                        <div class="bg-[#f6f8fb] rounded-lg p-5">
                            @if (! empty($c['image']))
                ...
                @if (! empty($d['modules']['capstone']))
                    ...
                    <div class="mt-12 bg-[#f6f8fb] rounded-lg p-6 md:p-8 grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
                        @if (! empty($cap['image']))
    ...
    @if (! empty($d['assessment']))
        <section class="bg-white py-16 md:py-20">
            <div class="max-w-[1200px] mx-auto px-4">
                <h2 class="text-[26px] md:text-[32px] font-bold text-[#14166e] uppercase leading-snug text-center mb-5">{{ $d['assessment']['heading'] }}</h2>
                @if (! empty($d['assessment']['intro']))
                    <p class="text-[15px] md:text-[16px] text-gray-700 text-center leading-relaxed mb-10">{{ $d['assessment']['intro'] }}</p>
                @endif
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                    <div class="space-y-6">
                        ...
                        @if (! empty($d['assessment']['closing']))
                            <p class="text-[15px] md:text-[16px] text-gray-700 leading-relaxed italic">{{ $d['assessment']['closing'] }}</p>
                        @endif
                    </div>
                    @if (! empty($d['assessment']['image']))
                        <div>
                            <img src="{{ $d['assessment']['image'] }}" alt="{{ $d['assessment']['heading'] }}" class="w-full h-auto rounded-md" loading="lazy">
                        </div>
                    @endif
                </div>
            </div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
                    @foreach ($d['accreditation']['standards'] as $s)
                        <div class="bg-white rounded-lg p-5 text-center">
                            ...
                            @endif
                            <h3 class="text-[15px] md:text-[16px] font-bold text-[#14166e] mb-2">{{ $s['title'] }}</h3>
                            <p class="text-[13px] md:text-[14px] text-gray-700 leading-relaxed">{{ $s['text'] }}</p>
                        </div>
                    @endforeach
                </div>
            </div>
            ...
            <div class="max-w-[1100px] mx-auto px-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
                    @foreach ($d['awards']['cards'] as $c)
                        <div class="bg-[#f6f8fb] rounded-lg p-6 text-center">
                            @if (! empty($c['image']))
                                <img src="{{ $c['image'] }}" alt="{{ $c['title'] }}" class="w-16 h-16 object-contain mx-auto mb-4" loading="lazy">
                            @endif
                            <h3 class="text-[16px] md:text-[18px] font-bold text-[#14166e] mb-3">{{ $c['title'] }}</h3>
                ...
                @if (! empty($d['awards']['participants_items']))
                    <div class="bg-[#f6f8fb] rounded-lg p-6 max-w-[800px] mx-auto">
