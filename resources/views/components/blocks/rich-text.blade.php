{{--
    Block: Rich Text
    Renders admin-entered rich text with the site's standard prose styling.
--}}
@php
...
<section class="py-12">
    <div class="{{ $wrapClass }} px-4 sm:px-6 lg:px-8">

        @if($heading)
            <h2 class="text-3xl font-bold text-[#0B2F5E] mb-6">{{ $heading }}</h2>
        @endif
