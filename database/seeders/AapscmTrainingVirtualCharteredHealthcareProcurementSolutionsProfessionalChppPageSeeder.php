...
/**
 * Transcribes https://aapscm.org/aapscm-training-virtual-chartered-healthcare-procurement-solutions-professional-chpp/
 *
 * Layout: intro (heading + body), topics (heading + intro paragraph + 7 bullets + img),
 * training_header, trainers (3), schedule (43 dates, label "(CHPP)®").
 */
class AapscmTrainingVirtualCharteredHealthcareProcurementSolutionsProfessionalChppPageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $pageData = [
            'hero' => [
                'title' => "Chartered Healthcare Procurement Solutions Professional (CHPP)\u{00ae}",
            ],
            'intro' => [
                'heading' => "CHARTERED HEALTHCARE PROCUREMENT SOLUTIONS PROFESSIONAL (CHPP)\u{00ae}",
                'body'    => "The CHPP\u{00ae} Certification is the foundation level for analysts or professions in medical or healthcare procurement professionals. Most health system leaders recognize these pitfalls as well as the importance of a strong clinical engagement structure. As value-based care gains traction, health systems are seeking to derive greater value from procurement and supply chain efforts, including by investing in initiatives to improve clinician engagement.Many health systems struggle to effectively engage with their clinicians on procurement and supply chain topics for a variety of reasons:",
            ],
            'topics' => [
                'heading' => 'Topics include the following',
                'intro'   => "Decisions concerning clinical supplies need to be made in lockstep with the clinicians who ultimately deliver patient care. Too often, one of two scenarios occurs, both with less-than-desirable outcomes. In the first, procurement teams drive a supply standardization initiative without proper clinical input, which can lead to substantial clinical resistance and potentially strained relationships. Alternatively, the health system makes no attempt to manage clinicians\u{2019} supply choices, which perpetuates a cycle of highly variable, costly care.",
                'items'   => [
                    'Medical Procurement Analytical Tools and Platforms',
                    'Clinical procurement and engagement workforce',
                    'Health and Public Procurement and Supply Chain',
                    'Use Cases in Healthcare Procurement',
                    'Data Analytics and Visualization in Healthcare Procurement',
                    'Contract management Processes in medical procurement',
                    'Best practices in Healthcare Procurement',
                ],
                'image' => UrlRewriter::image('https://aapscm.org/wp-content/uploads/2025/06/img.png'),
            ],
            'training_header' => [
                'heading' => "CHPP\u{00ae} Virtual/Online Instructor-led 4-day Training",
            ],
            'trainers' => [
                [
            ...
            'schedule' => [
                ...
                'options' => [
                    ...
                    'OCT 1-4, 2026 (+$1,200.00)', 'OCT 6-10, 2026 (+$1,200.00)', 'OCT 15-19, 2026 (+$1,200.00)', 'OCT 25-29, 2026 (+$1,200.01)',
        ...
        Page::updateOrCreate(
            ['slug' => 'aapscm-training-virtual-chartered-healthcare-procurement-solutions-professional-chpp'],
            [
                'title'            => "Instructor-led virtual training - AAPSCM\u{00ae} Training Virtual - Chartered Healthcare Procurement Solutions Professional (CHPP)\u{00ae}",
                'content'          => null,
                'excerpt'          => "AAPSCM\u{00ae} 4-day virtual/online instructor-led training for the Chartered Healthcare Procurement Solutions Professional (CHPP)\u{00ae} certification. $1,200. Covers medical procurement analytics, clinical engagement, healthcare supply chain best practices and contract management.",
                'status'           => 'published',
                'is_published'     => true,
                'template'         => 'standard_content',
                'page_data'        => $pageData,
                'meta_title'       => "Instructor-led virtual training - Chartered Healthcare Procurement Solutions Professional (CHPP)\u{00ae} - AAPSCM\u{00ae}",
                'meta_description' => "Enroll in the AAPSCM\u{00ae} 4-day virtual/online instructor-led CHPP\u{00ae} training for $1,200. Live sessions led by industry experts; multiple 2026 / 2027 / 2028 dates available.",
                'show_in_nav'      => false,
            ],
        );
    }
