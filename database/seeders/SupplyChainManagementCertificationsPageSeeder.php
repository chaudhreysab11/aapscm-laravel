...
class SupplyChainManagementCertificationsPageSeeder extends Seeder
{
    public function run(): void
    {
        $pageData = require database_path('seeders/data/supply-chain-management-certifications_data.php');

        $this->rewriteUrls($pageData);

        Page::updateOrCreate(
            ['slug' => 'supply-chain-management-certifications'],
            [
                'title'            => 'Supply Chain Management Certifications',
                'excerpt'          => 'Globally recognised AAPSCM® Supply Chain Management certifications for professionals and managers — covering AI, cybersecurity, sustainability, blockchain, risk and resilience.',
                'status'           => 'published',
                'is_published'     => true,
