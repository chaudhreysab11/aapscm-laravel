...
/**
 * Transcribes https://aapscm.org/aapscm-training-virtual-chartered-global-cross-border-e-commerce-manager-cgcbe/
 */
class AapscmTrainingVirtualCharteredGlobalCrossBorderECommerceManagerCgcbePageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $pageData = [
            'hero' => [
                'title' => "Chartered Global Cross-Border E-Commerce Manager (CGCBE)\u{00ae}",
            ],
            'intro' => [
                'heading' => "Chartered Global Cross-Border E-Commerce Manager (CGCBE)\u{00ae}",
            ...
            'why_cert' => [
                ...
                'heading' => 'Overview',
                'body'    => "The Chartered Global Cross-Border E-Commerce Manager (CGCBE)\u{00ae} certification is a world-class credential designed for professionals who want to lead and thrive in the increasingly globalized world of e-commerce. As businesses expand their reach across borders, there is a critical need for leaders with the expertise to navigate international markets, manage global supply chains, and ensure compliance with diverse regulations. This certification is for professionals and managers in e-commerce management and equips you with the skills to manage and grow cross-border e-commerce operations while addressing the complexities of global trade.",
            ],
            'modules' => [
                'heading' => 'Program Highlights',
                'items'   => [
                    self::module('Comprehensive Curriculum',         'Covers market entry strategies, cross-border logistics, regulatory compliance, and localization techniques.'),
                    self::module('Real-World Applications',          'Engage with case studies and projects to solve challenges in global e-commerce operations'),
                    self::module('Expert Faculty',                   'Learn from international trade professionals and e-commerce leaders with extensive global experience.'),
                    self::module('Globally Recognized Credential:',  'A credential recognized by top organizations as a standard for excellence in global e-commerce management.'),
                    self::module('Networking Opportunities',         'Access a global community of certified professionals and industry experts.'),
                ],
            ],
            'training_header' => [
                'heading' => "CGCBE\u{00ae} Virtual/Online Instructor-led 4-day Training",
            ],
            'trainers' => [
                [
        ...
        Page::updateOrCreate(
            ['slug' => 'aapscm-training-virtual-chartered-global-cross-border-e-commerce-manager-cgcbe'],
            [
                'title'            => "Instructor-led virtual training - Chartered Global Cross-Border E-Commerce Manager (CGCBE)\u{00ae}",
                'content'          => null,
                'excerpt'          => "AAPSCM\u{00ae} 4-day virtual/online instructor-led training for the Chartered Global Cross-Border E-Commerce Manager (CGCBE)\u{00ae} certification. $1,200. Lead and grow cross-border e-commerce operations across international markets.",
                'status'           => 'published',
                'is_published'     => true,
                'template'         => 'standard_content',
                'page_data'        => $pageData,
                'meta_title'       => "Instructor-led virtual training - Chartered Global Cross-Border E-Commerce Manager (CGCBE)\u{00ae} - AAPSCM\u{00ae}",
                'meta_description' => "Enroll in the AAPSCM\u{00ae} 4-day virtual/online instructor-led CGCBE\u{00ae} training for $1,200. Live sessions led by industry experts; multiple 2026 / 2027 dates available.",
                'show_in_nav'      => false,
            ],
        );
    }
