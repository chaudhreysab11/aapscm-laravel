...
/**
 * Transcribes https://aapscm.org/aapscm-training-virtual-american-certified-public-sector-procurement-compliance-specialist-ac-pspcs/
 *
 * Layout:
 *   why_cert (image + heading + single paragraph), topics (5 bullets + image),
 *   modules (10 cards, heading "Program Structure and Modules", no intro),
 *   training_header, trainers (3), schedule (41 dates, label "(AC-PSPC)®").
 */
class AapscmTrainingVirtualAmericanCertifiedPublicSectorProcurementComplianceSpecialistAcPspcsPageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $pageData = [
            ...
            'modules' => [
                ...
                'items'   => [
                    self::module('Introduction to Public Sector Procurement',                          'Explore the unique aspects of procurement within government and public institutions, including the impact of regulations and policies.'),
                    self::module('Regulatory Compliance in Public Procurement',                       'Learn about the legal requirements and regulations that govern public procurement, including federal, state, and local procurement laws.'),
                    self::module('Ethics and Accountability in Public Procurement',                   'Understand ethical standards and accountability practices that promote trust and integrity within public procurement.'),
                    self::module('Supplier Evaluation and Competitive Bidding',                       'Discover methods for fair supplier evaluation and the competitive bidding process, ensuring compliance with public procurement policies.'),
                    self::module('Transparency and Reporting Requirements',                           'Learn to maintain transparency through reporting and documentation, ensuring that procurement activities are open and accessible.'),
                    self::module('Contract Management and Quality Assurance',                         'Develop skills in advanced analytics to forecast supply chain needs, optimize decision-making, and improve procurement performance.'),
                    self::module('Risk Management in Public Procurement',                             'Identify and mitigate risks in public sector procurement, including compliance risks, supplier performance, and financial exposure.'),
                    self::module('Sustainable and Inclusive Procurement',                             'Explore sustainable procurement practices and strategies for inclusive procurement, ensuring fair opportunities for diverse suppliers.'),
                    self::module('Case Studies in Public Sector Procurement',                         'Analyze real-world case studies from the public sector, examining successful and unsuccessful procurement strategies to learn best practices.'),
                    self::module('Capstone Project: Developing a Public Procurement Compliance Strategy', 'Apply your learning by designing a comprehensive procurement compliance strategy for a hypothetical government agency, focusing on regulatory adherence, transparency, and accountability.'),
                ],
            ],
            'training_header' => [
                'heading' => "AC-PSPCS\u{00ae} Virtual/Online Instructor-led 4-day Training",
            ],
            'trainers' => [
                [
        ...
        Page::updateOrCreate(
            ['slug' => 'aapscm-training-virtual-american-certified-public-sector-procurement-compliance-specialist-ac-pspcs'],
            [
                'title'            => "Instructor-led virtual training - American Certified Public Sector Procurement & Compliance Professional(AC-PSPC)\u{00ae}",
                'content'          => null,
                'excerpt'          => "AAPSCM\u{00ae} 4-day virtual/online instructor-led training for the American Certified Public Sector Procurement & Compliance Professional (AC-PSPC)\u{00ae} certification. $1,200. Covers regulatory compliance, ethics, supplier evaluation, transparency and contract management.",
                'status'           => 'published',
                'is_published'     => true,
                'template'         => 'standard_content',
                'page_data'        => $pageData,
                'meta_title'       => "Instructor-led virtual training - American Certified Public Sector Procurement & Compliance Professional (AC-PSPC)\u{00ae} - AAPSCM\u{00ae}",
                'meta_description' => "Enroll in the AAPSCM\u{00ae} 4-day virtual/online instructor-led AC-PSPCS\u{00ae} training for $1,200. Live sessions led by industry experts; multiple 2026 / 2027 / 2028 dates available.",
                'show_in_nav'      => false,
            ],
        );
    }
