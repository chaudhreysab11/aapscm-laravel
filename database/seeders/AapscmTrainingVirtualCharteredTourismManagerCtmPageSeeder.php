...
/**
 * Transcribes https://aapscm.org/aapscm-training-virtual-chartered-tourism-manager-ctm/
 *
 * Layout: intro ("About CTM®" + 2 paragraphs) → why_cert (image + heading "Why go for ACPP Certification?" + 1 paragraph)
 *         → training_header → trainers (3, J/J use alt address) → schedule (44 dates).
 */
class AapscmTrainingVirtualCharteredTourismManagerCtmPageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $pageData = [
            'hero' => [
                'title' => "Chartered Tourism Manager (CTM)\u{00ae}",
            ],
            'intro' => [
                'heading'         => "About CTM\u{00ae}",
                'body_paragraphs' => [
                    "Welcome to the Chartered Tourism Manager (CTM)\u{00ae} program, proudly offered by the American Association of Procurement, Supply Chain, and Tourism Management (AAPSCM)\u{00ae}. This prestigious, advanced-level certification is your gateway to mastering the complexities of today\u{2019}s diverse hospitality and tourism sectors. From overseeing five-star hotels and airport operations to optimizing cruise line schedules and destination marketing strategies, CTM\u{00ae} equips you with the strategic insight, managerial skills, and innovative mindset required to excel in a dynamic, interconnected global market.",
                    "Chartered Tourism Manager (CTM)\u{00ae} is an advanced-level certification designed for professionals aiming to excel in the global hospitality and tourism industries. To ensure participants have a solid foundation, CTM\u{00ae} requires either completion of the American Certified Tourism Professional (ACTP)\u{00ae} credential (or an equivalent foundational certification in tourism management), or a minimum of six years of relevant industry experience.",
                ],
            ],
            'why_cert' => [
                'image'   => UrlRewriter::image('https://aapscm.org/wp-content/uploads/2025/06/1.jpg'),
                'heading' => 'Why go for ACPP Certification?',
                'body'    => "Seize the opportunity to transform your career, amplify your impact, and shape the future of hospitality and tourism. The Chartered Tourism Manager (CTM)\u{00ae} program offers a powerful blend of leadership development, strategic management, and sustainability practices\u{2014}all tailored for diverse sectors within the global travel landscape.",
            ],
            'training_header' => [
                'heading' => "CTM\u{00ae} Virtual/Online Instructor-led 4-day Training",
            ],
            'trainers' => [
                [
        ...
        Page::updateOrCreate(
            ['slug' => 'aapscm-training-virtual-chartered-tourism-manager-ctm'],
            [
                'title'            => "Instructor-led virtual training - Chartered Tourism Manager (CTM)\u{00ae}",
                'content'          => null,
                'excerpt'          => "AAPSCM\u{00ae} 4-day virtual/online instructor-led training for the Chartered Tourism Manager (CTM)\u{00ae} certification. $1,200. Master the complexities of today\u{2019}s diverse hospitality and tourism sectors with strategic insight, managerial skills, and an innovative mindset.",
                'status'           => 'published',
                'is_published'     => true,
                'template'         => 'standard_content',
                'page_data'        => $pageData,
                'meta_title'       => "Instructor-led virtual training - Chartered Tourism Manager (CTM)\u{00ae} - AAPSCM\u{00ae}",
                'meta_description' => "Enroll in the AAPSCM\u{00ae} 4-day virtual/online instructor-led CTM\u{00ae} training for $1,200. Live sessions led by industry experts; multiple 2026 / 2027 dates available.",
                'show_in_nav'      => false,
            ],
        );
    }
