...
/**
 * Transcribes https://aapscm.org/aapscm-training-virtual-chartered-advanced-supply-chain-cybersecurity-manager-ca-sccm/
 *
 * Layout: why_cert (2 paragraphs) → topics ("Why Choose CA-SCCM?" + 4 bullets + img)
 *         → modules (6 cards) → training_header → trainers (3) → schedule (43 dates).
 */
class AapscmTrainingVirtualCharteredAdvancedSupplyChainCybersecurityManagerCaSccmPageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $pageData = [
            'hero' => [
                'title' => "Get qualified automatically after earning CA-SCCM\u{00ae}",
            ],
            'why_cert' => [
                'heading'         => "About CA-SCCM\u{00ae}",
                'body_paragraphs' => [
                    'Safeguard Your Supply Chain Against Cyber Threats',
                    'The Advanced Supply Chain Cybersecurity Manager Certification (CA-ASCCM) equips professionals with the expertise to protect supply chain networks from evolving cyber threats. As digital transformation accelerates, securing supply chain operations has become critical for businesses worldwide. This program is your pathway to mastering cutting-edge cybersecurity techniques tailored for supply chain systems.',
                ],
            ],
            'topics' => [
                'heading' => 'Why Choose CA-SCCM?',
                'intro'   => 'Cybersecurity breaches in supply chains can lead to severe financial and reputational damage. The ASCCS certification prepares you to:',
                'items'   => [
                    'Protect Critical Data: Secure sensitive supply chain information against unauthorized access.',
                    'Identify and Mitigate Risks: Use advanced tools to detect vulnerabilities and prevent attacks.',
                    'Integrate Cybersecurity with AI and Blockchain: Leverage innovative technologies to build robust security frameworks.',
                    'Ensure Compliance: Align supply chain operations with global cybersecurity standards and regulations.',
                ],
            ...
            'modules' => [
                ...
                'items'   => [
                    self::module('Supply Chain Cyber Threats',         'Understand the vulnerabilities and attack vectors unique to supply chains.'),
                    self::module('AI-Driven Cybersecurity Solutions',  'Use AI tools for real-time threat detection and response.'),
                    self::module('Blockchain Security Integration',    'Implement blockchain for secure data sharing and tamper-proof transactions.'),
                    self::module('Incident Response Frameworks',       'Develop strategies for mitigating and recovering from cyberattacks.'),
                    self::module('Compliance Standards',               'Master global cybersecurity regulations like GDPR, CCPA, and ISO 27001.'),
                    self::module('Cyber Risk Assessment',              'Learn how to evaluate and fortify weak points in your supply chain network.'),
                ],
            ],
            'training_header' => [
                'heading' => "CA-SCCM\u{00ae} Virtual/Online Instructor-led 4-day Training",
            ],
            'trainers' => [
                [
        ...
        Page::updateOrCreate(
            ['slug' => 'aapscm-training-virtual-chartered-advanced-supply-chain-cybersecurity-manager-ca-sccm'],
            [
                'title'            => "Instructor-led virtual training - Chartered Advanced Supply Chain Cybersecurity Manager (CA-SCCM)\u{00ae}",
                'content'          => null,
                'excerpt'          => "AAPSCM\u{00ae} 4-day virtual/online instructor-led training for the Chartered Advanced Supply Chain Cybersecurity Manager (CA-SCCM)\u{00ae} certification. $1,200. Master cyber risk, AI-driven defense, blockchain integration, and global compliance.",
                'status'           => 'published',
                'is_published'     => true,
                'template'         => 'standard_content',
                'page_data'        => $pageData,
                'meta_title'       => "Instructor-led virtual training - Chartered Advanced Supply Chain Cybersecurity Manager (CA-SCCM)\u{00ae} - AAPSCM\u{00ae}",
                'meta_description' => "Enroll in the AAPSCM\u{00ae} 4-day virtual/online instructor-led CA-SCCM\u{00ae} training for $1,200. Live sessions led by industry experts; multiple 2026 / 2027 / 2028 dates available.",
                'show_in_nav'      => false,
            ],
        );
    }
