...
/**
 * Transcribes https://aapscm.org/aapscm-training-virtual-chartered-e-commerce-data-analytics-and-ai-professional-ced-ai/
 */
class AapscmTrainingVirtualCharteredECommerceDataAnalyticsAndAiProfessionalCedAiPageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $pageData = [
            'hero' => [
                'title' => "Chartered E-Commerce Data Analytics and AI Professional (CED-AI)\u{00ae}",
            ],
            'intro' => [
                'heading' => "Chartered E-Commerce Data Analytics and AI Professional (CED-AI)\u{00ae}",
            ...
            'why_cert' => [
                ...
                'heading' => 'Overview',
                'body'    => "The Chartered E-Commerce Data Analytics and AI Professional (CED-AI)\u{00ae} certification is a cutting-edge credential designed for professionals who aim to master the intersection of e-commerce, data analytics, and artificial intelligence (AI). This globally recognized certification equips individuals with advanced skills to harness data insights, optimize operations, and implement AI-driven solutions for unparalleled success in digital commerce. In a rapidly evolving marketplace, this certification positions you as a forward-thinking leader capable of leveraging data and technology to drive innovation and growth.",
            ],
            'modules' => [
                'heading' => 'Program Highlights',
                'items'   => [
                    self::module('Comprehensive Curriculum',          'Covering data analytics, machine learning, AI applications, and ethical practices in e-commerce.'),
                    self::module('Real-World Applications',           'Case studies, hands-on projects, and simulations to ensure actionable insights and practical skills.'),
                    self::module('Expert Faculty',                    'Learn from data science, AI, and e-commerce strategy leaders with extensive industry experience.'),
                    self::module('Globally Recognized Credential:',   'A certification respected by top organizations in e-commerce, data science, and AI.'),
                    self::module('Future-focused learning',           'Stay ahead with the latest AI and data analytics advancements tailored for e-commerce.'),
                ],
            ],
            'training_header' => [
                'heading' => "CED-AI\u{00ae} Virtual/Online Instructor-led 4-day Training",
            ],
            'trainers' => [
                [
        ...
        Page::updateOrCreate(
            ['slug' => 'aapscm-training-virtual-chartered-e-commerce-data-analytics-and-ai-professional-ced-ai'],
            [
                'title'            => "Instructor-led virtual training - Chartered E-Commerce Data Analytics and AI Professional (CED-AI)\u{00ae}",
                'content'          => null,
                'excerpt'          => "AAPSCM\u{00ae} 4-day virtual/online instructor-led training for the Chartered E-Commerce Data Analytics and AI Professional (CED-AI)\u{00ae} certification. $1,200. Master e-commerce data analytics and AI to drive innovation and growth in digital commerce.",
                'status'           => 'published',
                'is_published'     => true,
                'template'         => 'standard_content',
                'page_data'        => $pageData,
                'meta_title'       => "Instructor-led virtual training - Chartered E-Commerce Data Analytics and AI Professional (CED-AI)\u{00ae} - AAPSCM\u{00ae}",
                'meta_description' => "Enroll in the AAPSCM\u{00ae} 4-day virtual/online instructor-led CED-AI\u{00ae} training for $1,200. Live sessions led by industry experts; multiple 2026 / 2027 dates available.",
                'show_in_nav'      => false,
            ],
        );
    }
