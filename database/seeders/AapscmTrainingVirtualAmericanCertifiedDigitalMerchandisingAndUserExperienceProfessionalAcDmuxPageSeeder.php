...
/**
 * Transcribes https://aapscm.org/aapscm-training-virtual-american-certified-digital-merchandising-and-user-experience-professional-ac-dmux/
 *
 * Layout: intro (cert title + "Internationally Recognized..." subtitle) → why_cert ("Overview" + body + image)
 *         → modules ("Program Highlights" 4 cards) → training_header → trainers (3, J/J alt address) → schedule (44 dates).
 */
class AapscmTrainingVirtualAmericanCertifiedDigitalMerchandisingAndUserExperienceProfessionalAcDmuxPageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $pageData = [
            'hero' => [
                'title' => "American Certified Digital Merchandising and User Experience Professional (AC-DMUX)\u{00ae}",
            ],
            'intro' => [
                'heading' => "American Certified Digital Merchandising and User Experience Professional (AC-DMUX)\u{00ae}",
            ...
            'why_cert' => [
                ...
                'heading' => 'Overview',
                'body'    => "The AC-DMUX\u{00ae} Certification is a premier credential designed to empower professionals with advanced Digital merchandising and user experience (UX) optimization. Skills Tailored for the dynamic e-commerce landscape, this certification combines the art of crafting compelling digital storefronts with the science of enhancing customer journeys. This certification is for professionals in the field of e-commerce administration. If you aspire to excel in the competitive world of online retail, the AC-DMUX\u{00ae} certification is your gateway to success.",
            ],
            'modules' => [
                'heading' => 'Program Highlights',
                'items'   => [
                    self::module('Comprehensive Curriculum',         'Covering digital merchandising, UX design principles, and data-driven decision-making.'),
                    self::module('Interactive Learning',             'Case studies, hands-on projects, and real-world examples to ensure practical application of knowledge.'),
                    self::module('Industry Expert Faculty',          'Learn from seasoned professionals and thought leaders in e-commerce and UX design.'),
                    self::module('Globally Recognized Certification', 'A mark of excellence in the field of digital merchandising and user experience.'),
                ],
            ],
            'training_header' => [
                'heading' => "AC-DMUX\u{00ae} Virtual/Online Instructor-led 4-day Training",
            ],
            'trainers' => [
                [
        ...
        Page::updateOrCreate(
            ['slug' => 'aapscm-training-virtual-american-certified-digital-merchandising-and-user-experience-professional-ac-dmux'],
            [
                'title'            => "Instructor-led virtual training - American Certified Digital Merchandising and User Experience Professional (AC-DMUX)\u{00ae}",
                'content'          => null,
                'excerpt'          => "AAPSCM\u{00ae} 4-day virtual/online instructor-led training for the American Certified Digital Merchandising and User Experience Professional (AC-DMUX)\u{00ae} certification. $1,200. Master digital merchandising and UX optimization for the dynamic e-commerce landscape.",
                'status'           => 'published',
                'is_published'     => true,
                'template'         => 'standard_content',
                'page_data'        => $pageData,
                'meta_title'       => "Instructor-led virtual training - American Certified Digital Merchandising and User Experience Professional (AC-DMUX)\u{00ae} - AAPSCM\u{00ae}",
                'meta_description' => "Enroll in the AAPSCM\u{00ae} 4-day virtual/online instructor-led AC-DMUX\u{00ae} training for $1,200. Live sessions led by industry experts; multiple 2026 / 2027 dates available.",
                'show_in_nav'      => false,
            ],
        );
    }
