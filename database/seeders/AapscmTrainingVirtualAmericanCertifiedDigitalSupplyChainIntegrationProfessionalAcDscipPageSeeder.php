...
/**
 * Transcribes https://aapscm.org/aapscm-training-virtual-american-certified-digital-supply-chain-integration-professional-ac-dscip/
 *
 * Layout: why_cert (1 paragraph) → topics ("Why Choose AC-DSIP?" + 4 bullets + img)
 *         → modules ("Program Structure and Modules" 6 cards) → training_header → trainers (3) → schedule (43 dates).
 */
class AapscmTrainingVirtualAmericanCertifiedDigitalSupplyChainIntegrationProfessionalAcDscipPageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $pageData = [
            'hero' => [
                'title' => "American Certified Digital Supply Chain Integration Professional (AC-DSCI)\u{00ae}",
            ],
            'why_cert' => [
                'heading'         => "About AC-DSCIP\u{00ae}",
                'body_paragraphs' => [
                    'Master the Digital Transformation of Supply Chains',
                    'The American CertifiedDigital Supply Chain Integration Professional Certification (AC-DSIP) equips professionals with the expertise to transform traditional supply chains into agile, data-driven, and fully integrated systems. This program provides the skills to leverage digital technologies such as ERP systems, IoT, and AI to create seamless and highly efficient supply chains.',
                ],
            ],
            'topics' => [
                'heading' => 'Why Choose AC-DSIP?',
                'intro'   => 'Digital transformation is revolutionizing supply chain management. The AC-DSIP certification prepares you to:',
                'items'   => [
                    'Optimize Operations: Use cutting-edge tools to streamline logistics, inventory, and procurement processes.',
                    'Enhance Real-Time Visibility: Monitor supply chain activities using IoT devices and cloud-based platforms.',
                    'Boost Decision-Making: Leverage AI and data analytics for informed, real-time decision-making.',
                    'Improve Collaboration: Integrate digital platforms to enhance collaboration across suppliers, manufacturers, and distributors.',
                ],
            ...
            'modules' => [
                ...
                'items'   => [
                    self::module('ERP Systems and Supply Chain Platforms', 'Master systems like SAP, Oracle, and Microsoft Dynamics to manage end to end supply chain processes.'),
                    self::module('IoT Integration',                        'Implement IoT technologies to track assets, monitor inventory, and manage transportation in real time.'),
                    self::module('Digital Twin Modeling',                  'Create virtual replicas of supply chains for predictive analytics and scenario planning.'),
                    self::module('Cloud Computing for Supply Chains',      'Learn how to utilize cloud-based solutions for scalability and collaborative workflows.'),
                    self::module('AI and Big Data Analytics',              'Discover how to analyze supply chain data to optimize efficiency and performance.'),
                    self::module('Automation in Supply Chains',            'Implement robotic process automation (RPA) to eliminate repetitive tasks and enhance productivity.'),
                ],
            ],
            'training_header' => [
                'heading' => "AC-DSCI\u{00ae} Virtual/Online Instructor-led 4-day Training",
            ],
            'trainers' => [
                [
        ...
        Page::updateOrCreate(
            ['slug' => 'aapscm-training-virtual-american-certified-digital-supply-chain-integration-professional-ac-dscip'],
            [
                'title'            => "Instructor-led virtual training - American Certified Digital Supply Chain Integration Professional (AC-DSCI)\u{00ae}",
                'content'          => null,
                'excerpt'          => "AAPSCM\u{00ae} 4-day virtual/online instructor-led training for the American Certified Digital Supply Chain Integration Professional (AC-DSCI)\u{00ae} certification. $1,200. Master ERP, IoT, AI and digital twin tools to build agile, data-driven, fully integrated supply chains.",
                'status'           => 'published',
                'is_published'     => true,
                'template'         => 'standard_content',
                'page_data'        => $pageData,
                'meta_title'       => "Instructor-led virtual training - American Certified Digital Supply Chain Integration Professional (AC-DSCI)\u{00ae} - AAPSCM\u{00ae}",
                'meta_description' => "Enroll in the AAPSCM\u{00ae} 4-day virtual/online instructor-led AC-DSCI\u{00ae} training for $1,200. Live sessions led by industry experts; multiple 2026 / 2027 / 2028 dates available.",
                'show_in_nav'      => false,
            ],
        );
    }
