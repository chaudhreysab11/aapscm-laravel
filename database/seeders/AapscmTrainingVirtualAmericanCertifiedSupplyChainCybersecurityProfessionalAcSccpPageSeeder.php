...
/**
 * Transcribes https://aapscm.org/aapscm-training-virtual-american-certified-supply-chain-cybersecurity-professional-ac-sccp/
 *
 * Layout: why_cert (2 paragraphs) → topics (Why Choose, intro + 4 bullets + img)
 *         → modules (6 cards) → training_header → trainers (3) → schedule (43 dates).
 */
class AapscmTrainingVirtualAmericanCertifiedSupplyChainCybersecurityProfessionalAcSccpPageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $pageData = [
            'hero' => [
                'title' => "American Certified Supply Chain Cybersecurity Professional (AC-SCCP)\u{00ae}",
            ],
            'why_cert' => [
                'heading'         => "About AC-SCCP\u{00ae}",
                'body_paragraphs' => [
            ...
            'topics' => [
                ...
                'items'   => [
                    'Understand Cybersecurity Basics: Learn how cyber threats impact supply chains and how to counteract them.',
                    'Identify Risks: Use simple tools to pinpoint vulnerabilities in your supply chain.',
                    'Enhance Data Security: Protect sensitive information from unauthorized access.',
                    'Comply with Standards: Understand the basics of global cybersecurity regulations and their importance for your operations.',
                ],
            ...
            'modules' => [
                ...
                'items'   => [
                    self::module('Introduction to Cybersecurity in Supply Chains', 'Get familiar with common cybersecurity risks and why supply chains are a prime target.'),
                    self::module('Basic Risk Assessment',                          'Learn how to spot weak points in your supply chain and take steps to address them.'),
                    self::module('Data Protection Essentials',                     'Understand how to secure data across supply chain networks.'),
                    self::module('Cybersecurity Tools for Beginners',              'Discover simple tools and methods to improve security.'),
                    self::module('Incident Response Basics',                       'Learn how to respond to a cyberattack and minimize its impact.'),
                    self::module('Understanding Compliance',                       'Gain a basic understanding of key global regulations like GDPR and ISO standards.'),
                ],
            ],
            'training_header' => [
                'heading' => "AC-SCCP\u{00ae} Virtual/Online Instructor-led 4-day Training",
            ],
            'trainers' => [
                [
        ...
        Page::updateOrCreate(
            ['slug' => 'aapscm-training-virtual-american-certified-supply-chain-cybersecurity-professional-ac-sccp'],
            [
                'title'            => "Instructor-led virtual training - American Certified Supply Chain Cybersecurity Professional (AC-SCCP)\u{00ae}",
                'content'          => null,
                'excerpt'          => "AAPSCM\u{00ae} 4-day virtual/online instructor-led training for the American Certified Supply Chain Cybersecurity Professional (AC-SCCP)\u{00ae} certification. $1,200. Foundational skills to protect supply chains from cyber risks.",
                'status'           => 'published',
                'is_published'     => true,
                'template'         => 'standard_content',
                'page_data'        => $pageData,
                'meta_title'       => "Instructor-led virtual training - American Certified Supply Chain Cybersecurity Professional (AC-SCCP)\u{00ae} - AAPSCM\u{00ae}",
                'meta_description' => "Enroll in the AAPSCM\u{00ae} 4-day virtual/online instructor-led AC-SCCP\u{00ae} training for $1,200. Live sessions led by industry experts; multiple 2026 / 2027 / 2028 dates available.",
                'show_in_nav'      => false,
            ],
        );
    }
