...
/**
 * Transcribes https://aapscm.org/aapscm-training-virtual-american-certified-tourism-professional-actp/
 *
 * Sections (canonical, desktop variant — sections 6+):
 *   hero, intro, topics (heading + intro + 3 bullets + closing + image),
 *   training_header, trainers (3), schedule.
 *
 * No `why_cert` 2-col block on this page.
 */
class AapscmTrainingVirtualAmericanCertifiedTourismProfessionalActpPageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $pageData = [
            'hero' => [
                'title' => "American Certified Tourism Professional (ACTP)\u{00ae}",
            ],
            'intro' => [
                'heading' => "The American Certified Tourism Professional (ACTP\u{00ae})",
                'body'    => "Tourism is one of the world\u{2019}s leading industries and a major economic development tool, and as such, security (crime and terrorism) has a major impact on the tourism and event-oriented economies. Tourists today demand safety and security by well-trained professionals. The hospitality industry\u{2019}s number one job is to protect its guests. If it fails in this regard, all else become irrelevant. Real security involves training, education, investments in software and the understanding that security is not a simplistic discipline. The American Certified Tourism Professional (ACTP\u{00ae}) certification shows future employers that you have the practical knowledge, insights, and professional expertise to understand factors that impact how people spend their leisure time. The certification explores how to better support and develop opportunities for recreation and tourism that benefit the economy and environment as well as the mental, emotional, and physical well-being of people and communities. This certification is a pre-requisite for ACTM\u{00ae} which is the standard certification for Managers in Tourism.",
            ],
            'topics' => [
                'heading' => 'Topics and Description',
                'intro'   => "The American Certified Tourism Professional (ACTP\u{00ae}) certification provides assessment in the areas of Hospitality, tourism management and marketing, Destination marketing and management, Sustainable tourism, Tourism and environment, Tourism planning and regional development, Entrepreneurship in Tourism and Hospitality The ACTP\u{00ae} certification will certify in the following objectives To be able to recognize and address tourist related security and safety concerns and thus increase business :",
                'items'   => [
                ...
                'closing' => "This exam includes basic information on procurement, Importance of the procurement organization and its\u{2019} role in the organization, cost vs. value, processes such as the use of RFQ, RFP, RFX, Differences between direct and indirect procurement, e-Procurement, and involving users and suppliers.",
                'image'   => UrlRewriter::image('https://aapscm.org/wp-content/uploads/2025/06/img.png'),
            ],
            'training_header' => [
                'heading' => "ACTP\u{00ae} Virtual/Online Instructor-led 4-day Training",
            ],
            'trainers' => [
                [
        ...
        Page::updateOrCreate(
            ['slug' => 'aapscm-training-virtual-american-certified-tourism-professional-actp'],
            [
                'title'            => "Instructor-led virtual training - American Certified Tourism Professional (ACTP)\u{00ae}",
                'content'          => null,
                'excerpt'          => "AAPSCM\u{00ae} 4-day virtual/online instructor-led training for the American Certified Tourism Professional (ACTP)\u{00ae} certification. $1,200. Led by Gleb Mikulich, Dr. Jason Matyus and James Raussen.",
                'status'           => 'published',
                'is_published'     => true,
                'template'         => 'standard_content',
                'page_data'        => $pageData,
                'meta_title'       => "Instructor-led virtual training - American Certified Tourism Professional (ACTP)\u{00ae} - AAPSCM\u{00ae}",
                'meta_description' => "Enroll in the AAPSCM\u{00ae} 4-day virtual/online instructor-led ACTP\u{00ae} training for $1,200. Live sessions led by industry experts; multiple 2026 / 2027 / 2028 dates available.",
                'show_in_nav'      => false,
            ],
        );
    }
