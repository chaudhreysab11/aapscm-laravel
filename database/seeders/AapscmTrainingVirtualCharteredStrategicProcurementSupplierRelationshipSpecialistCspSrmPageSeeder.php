...
/**
 * Transcribes https://aapscm.org/aapscm-training-virtual-chartered-strategic-procurement-supplier-relationship-specialist-csp-srm/
 *
 * Layout: why_cert (image + heading + body), topics (heading + 5 bullets + img),
 * training_header, trainers (3), schedule (43 dates, label "(CSP-SRM)®").
 */
class AapscmTrainingVirtualCharteredStrategicProcurementSupplierRelationshipSpecialistCspSrmPageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $pageData = [
            ...
            'why_cert' => [
                ...
                'heading' => "About CSP-SRM\u{00ae}",
                'body'    => 'Strategic Procurement and Supplier Relationship Management (CSP-SRM) is a critical aspect of modern supply chain management that focuses on optimizing supplier partnerships to achieve cost efficiency, quality assurance, innovation, and long-term business sustainability. Advanced CSP-SRM professionals leverage technology, data analytics, and strategic frameworks to drive value across procurement operations.',
            ],
            'topics' => [
                'heading' => 'Key Functions of a CSP-SRM Specialist',
                'items'   => [
            ...
            'training_header' => [
                'heading' => "CSP-SRM\u{00ae} Virtual/Online Instructor-led 4-day Training",
            ],
            'trainers' => [
                [
        ...
        Page::updateOrCreate(
            ['slug' => 'aapscm-training-virtual-chartered-strategic-procurement-supplier-relationship-specialist-csp-srm'],
            [
                'title'            => "Instructor-led virtual training - Chartered Strategic Procurement & Supplier Relationship Manager(CSP-SRM)\u{00ae}",
                'content'          => null,
                'excerpt'          => "AAPSCM\u{00ae} 4-day virtual/online instructor-led training for the Chartered Strategic Procurement & Supplier Relationship Manager (CSP-SRM)\u{00ae} certification. $1,200. Covers supplier selection, contract management, performance monitoring, risk assessment and collaboration.",
                'status'           => 'published',
                'is_published'     => true,
                'template'         => 'standard_content',
                'page_data'        => $pageData,
                'meta_title'       => "Instructor-led virtual training - Chartered Strategic Procurement & Supplier Relationship Manager(CSP-SRM)\u{00ae} - AAPSCM\u{00ae}",
                'meta_description' => "Enroll in the AAPSCM\u{00ae} 4-day virtual/online instructor-led CSP-SRM\u{00ae} training for $1,200. Live sessions led by industry experts; multiple 2026 / 2027 / 2028 dates available.",
                'show_in_nav'      => false,
            ],
        );
    }
