...
/**
 * Transcribes https://aapscm.org/aapscm-training-virtual-american-certified-ethical-practices-amp-sustainable-e-commerce-professional-ac-seep/
 *
 ...
 */
class AapscmTrainingVirtualAmericanCertifiedEthicalPracticesAmpSustainableECommerceProfessionalAcSeepPageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $pageData = [
            'hero' => [
                'title' => "American Certified Ethical Practices & Sustainable E-Commerce Professional (AC-SEEP)\u{00ae}",
            ],
            'intro' => [
                'heading' => "American Certified Ethical Practices & Sustainable E-Commerce Professional (AC-SEEP)\u{00ae}",
            ...
            'why_cert' => [
                ...
                'heading' => 'Overview',
                'body'    => "The AC-SEEP\u{00ae} Certification is the industry-leading credential for professionals committed to building ethical, sustainable, and impactful e-commerce ecosystems. As e-commerce transforms global markets, businesses and consumers increasingly prioritize transparency, sustainability, and ethical practices. This certification equips you with the skills and knowledge to lead in this critical space, ensuring compliance, innovation, and long-term value in your digital operations. This certification is also in the field of e-commerce administration.",
            ],
            'modules' => [
                'heading' => 'Program Highlights',
                'items'   => [
                    self::module('Comprehensive Curriculum', 'Covers key areas like ethical practices, sustainable logistics, regulatory compliance, and eco-friendly e-commerce solutions.'),
                    self::module('Practical Applications',   'Hands-on projects and real-world case studies to ensure actionable insights.'),
                    self::module('Global Perspective',       'Learn from examples and trends shaping e-commerce sustainability worldwide.'),
                    self::module('Expert Faculty',           'Led by industry thought leaders with expertise in ethical and sustainable digital commerce.'),
                ],
            ],
            'training_header' => [
                'heading' => "AC-SEEP\u{00ae} Virtual/Online Instructor-led 4-day Training",
            ],
            'trainers' => [
                [
        ...
        Page::updateOrCreate(
            ['slug' => 'aapscm-training-virtual-american-certified-ethical-practices-amp-sustainable-e-commerce-professional-ac-seep'],
            [
                'title'            => "Instructor-led virtual training - American Certified Ethical Practices & Sustainable E-Commerce Professional (AC-SEEP)\u{00ae}",
                'content'          => null,
                'excerpt'          => "AAPSCM\u{00ae} 4-day virtual/online instructor-led training for the American Certified Ethical Practices & Sustainable E-Commerce Professional (AC-SEEP)\u{00ae} certification. $1,200. Build ethical, sustainable, and impactful e-commerce ecosystems with transparency, compliance, and innovation.",
                'status'           => 'published',
                'is_published'     => true,
                'template'         => 'standard_content',
                'page_data'        => $pageData,
                'meta_title'       => "Instructor-led virtual training - American Certified Ethical Practices & Sustainable E-Commerce Professional (AC-SEEP)\u{00ae} - AAPSCM\u{00ae}",
                'meta_description' => "Enroll in the AAPSCM\u{00ae} 4-day virtual/online instructor-led AC-SEEP\u{00ae} training for $1,200. Live sessions led by industry experts; multiple 2026 / 2027 dates available.",
                'show_in_nav'      => false,
            ],
        );
    }
