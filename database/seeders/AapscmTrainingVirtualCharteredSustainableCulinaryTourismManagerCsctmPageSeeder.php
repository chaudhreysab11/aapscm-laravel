...
/**
 * Transcribes https://aapscm.org/aapscm-training-virtual-chartered-sustainable-culinary-tourism-manager-csctm/
 *
 * Layout: why_cert (heading "Chartered Sustainable Culinary Tourism Manager (CSCTM®)" + 2 paragraphs, no image)
 *         → modules ("Program Structure and Modules" 5 cards) → training_header → trainers (3, J/J use alt address) → schedule (44 dates).
 */
class AapscmTrainingVirtualCharteredSustainableCulinaryTourismManagerCsctmPageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $pageData = [
            'hero' => [
                'title' => "Chartered Sustainable Culinary Tourism Manager (CSCTM)\u{00ae}",
            ],
            'why_cert' => [
                'heading'         => "Chartered Sustainable Culinary Tourism Manager (CSCTM\u{00ae})",
                'body_paragraphs' => [
                    "Take your career in culinary tourism to the next level with the Chartered Sustainable Culinary Tourism Manager (CSCTM\u{00ae}) certification! This internationally recognized program is designed for tourism professionals, entrepreneurs, and policymakers who are passionate about creating impactful, eco-conscious food tourism experiences.",
                    "As a CSCTM\u{00ae}-certified professional, you\u{2019}ll gain the skills to lead sustainable culinary tourism initiatives that preserve cultural heritage, support local communities, and align with global sustainability goals. Whether you\u{2019}re managing culinary events, promoting farm-to-table experiences, or crafting innovative food tours, this certification sets you apart as a leader in the dynamic field of culinary tourism.",
                ],
            ],
            'modules' => [
                'heading' => 'Program Structure and Modules',
                'items'   => [
                    self::module('Global Recognition',       'Join an elite network of tourism professionals recognized for their expertise in sustainable culinary tourism.'),
                    self::module('Comprehensive Learning',   'Master sustainability principles, culinary tourism management, ethical sourcing, cultural preservation, and more.'),
                    self::module('Practical Application',    'Apply your skills to real-world projects, case studies, and hands-on experiences.'),
                    self::module('Career Advancement',       'Elevate your professional profile and open doors to new opportunities in the tourism and hospitality industry.'),
                    self::module('Networking Opportunities', 'Connect with industry leaders, chefs, and sustainability advocates worldwide.'),
                ],
            ],
            'training_header' => [
                'heading' => "CSCTM\u{00ae} Virtual/Online Instructor-led 4-day Training",
            ],
            'trainers' => [
                [
            ...
            'schedule' => [
                ...
                'options' => [
                    ...
                    'SEPT 1-4, 2027 (+$1,200.00)', 'SEPT 6-11, 2027 (+$1,200.00)', 'SEPT 15-19, 2027 (+$1,200.00)', 'SEPT 25-29, 2027 (+$1,200.00)',
                ],
        ...
        Page::updateOrCreate(
            ['slug' => 'aapscm-training-virtual-chartered-sustainable-culinary-tourism-manager-csctm'],
            [
                'title'            => "Instructor-led virtual training - Chartered Sustainable Culinary Tourism Manager (CSCTM)\u{00ae}",
                'content'          => null,
                'excerpt'          => "AAPSCM\u{00ae} 4-day virtual/online instructor-led training for the Chartered Sustainable Culinary Tourism Manager (CSCTM)\u{00ae} certification. $1,200. Lead sustainable culinary tourism initiatives that preserve cultural heritage, support local communities, and align with global sustainability goals.",
                'status'           => 'published',
                'is_published'     => true,
                'template'         => 'standard_content',
                'page_data'        => $pageData,
                'meta_title'       => "Instructor-led virtual training - Chartered Sustainable Culinary Tourism Manager (CSCTM)\u{00ae} - AAPSCM\u{00ae}",
                'meta_description' => "Enroll in the AAPSCM\u{00ae} 4-day virtual/online instructor-led CSCTM\u{00ae} training for $1,200. Live sessions led by industry experts; multiple 2026 / 2027 dates available.",
                'show_in_nav'      => false,
            ],
        );
    }
