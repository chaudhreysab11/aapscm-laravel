...
/**
 * Transcribes https://aapscm.org/aapscm-training-virtual-chartered-ai-driven-sustainable-procurement-manager-ca-ispm/
 *
 * Layout: why_cert (2 paragraphs) → topics ("Why Choose CAI-SPM?" + 4 bullets + img)
 *         → modules ("What You'll Learn" 6 cards) → training_header → trainers (3) → schedule (43 dates).
 */
class AapscmTrainingVirtualCharteredAiDrivenSustainableProcurementManagerCaIspmPageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $pageData = [
            'hero' => [
                'title' => "Chartered AI-Driven Sustainable Procurement Manager (CAI-SPM)\u{00ae}",
            ],
            'why_cert' => [
                'heading'         => "About CAI-SPM\u{00ae}",
                'body_paragraphs' => [
                    'Transform Procurement Practices with AI and Sustainability',
                    'The AI-Driven Sustainable Procurement Manager Certification (CA-ISPM) is designed to empower professionals to lead the future of ethical and sustainable procurement. This program combines cutting-edge artificial intelligence tools with proven sustainability strategies to help organizations achieve environmental, social, and governance (ESG) goals while maintaining profitability.',
                ],
            ],
            'topics' => [
                'heading' => 'Why Choose CAI-SPM?',
                'intro'   => 'The procurement landscape is evolving, with organizations increasingly focusing on sustainability and ethical sourcing. The CAISPM certification equips you to:',
                'items'   => [
                    'Leverage AI for Ethical Sourcing: Use AI tools to evaluate suppliers based on sustainability and compliance.',
                    'Optimize Procurement Decisions: Apply data-driven insights to reduce costs and environmental impact.',
                    'Drive Circular Economy Practices: Implement strategies to reuse, recycle, and minimize waste in procurement.',
                    'Ensure ESG Compliance: Stay aligned with global sustainability standards and regulations.',
                ],
                'image' => UrlRewriter::image('https://aapscm.org/wp-content/uploads/2025/06/img.png'),
            ],
            'modules' => [
                'heading' => "What You\u{2019}ll Learn",
                'items'   => [
                    self::module('AI Applications in Procurement',     'Discover how AI can transform supplier evaluations, contract analysis, and risk assessment.'),
                    self::module('Sustainable Procurement Strategies', 'Learn methods to identify ethical suppliers and reduce procurement-related environmental impact.'),
                    self::module('Carbon Footprint Tracking',          'Use AI tools to monitor and minimize carbon emissions in procurement activities.'),
                    self::module('Circular Supply Chain Integration',  'Implement circular economy principles to promote recycling and reuse.'),
                    self::module('Sustainability Reporting',           "Understand how to measure and report on procurement\u{2019}s impact on ESG goals."),
                    self::module('Global Compliance and Standards',    'Gain insights into sustainability regulations like the UN Sustainable Development Goals (SDGs).'),
                ],
            ],
            'training_header' => [
                'heading' => "CAI-SPM\u{00ae} Virtual/Online Instructor-led 4-day Training",
            ],
            'trainers' => [
                [
        ...
        Page::updateOrCreate(
            ['slug' => 'aapscm-training-virtual-chartered-ai-driven-sustainable-procurement-manager-ca-ispm'],
            [
                'title'            => "Instructor-led virtual training - Chartered AI-Driven Sustainable Procurement Manager (CAI-SPM)\u{00ae}",
                'content'          => null,
                'excerpt'          => "AAPSCM\u{00ae} 4-day virtual/online instructor-led training for the Chartered AI-Driven Sustainable Procurement Manager (CAI-SPM)\u{00ae} certification. $1,200. Lead ethical and sustainable procurement using AI tools and ESG strategies.",
                'status'           => 'published',
                'is_published'     => true,
                'template'         => 'standard_content',
                'page_data'        => $pageData,
                'meta_title'       => "Instructor-led virtual training - Chartered AI-Driven Sustainable Procurement Manager (CAI-SPM)\u{00ae} - AAPSCM\u{00ae}",
                'meta_description' => "Enroll in the AAPSCM\u{00ae} 4-day virtual/online instructor-led CAI-SPM\u{00ae} training for $1,200. Live sessions led by industry experts; multiple 2026 / 2027 / 2028 dates available.",
                'show_in_nav'      => false,
            ],
        );
    }
