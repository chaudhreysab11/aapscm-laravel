...
/**
 * Transcribes https://aapscm.org/aapscm-training-virtual-american-certified-e-commerce-strategy-and-growth-professional-ac-esgp/
 *
 * Layout: intro (cert title + "Internationally Recognized..." subtitle) → why_cert ("Overview" + body + image)
 *         → modules ("Program Highlights" 5 cards) → training_header → trainers (3, J/J alt address) → schedule (44 dates).
 */
class AapscmTrainingVirtualAmericanCertifiedECommerceStrategyAndGrowthProfessionalAcEsgpPageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $pageData = [
            'hero' => [
                'title' => "American Certified E-Commerce Strategy and Growth Professional (AC-ESGP)\u{00ae}",
            ],
            'intro' => [
                'heading' => "American Certified E-Commerce Strategy and Growth Professional (AC-ESGP)\u{00ae}",
            ...
            'why_cert' => [
                ...
                'heading' => 'Overview',
                'body'    => "The American Certified E-Commerce Strategy and Growth Professional (AC-ESGP)\u{00ae} certification is a comprehensive program designed to prepare professionals for leadership in the ever-evolving world of e-commerce. This globally recognized credential equips individuals with the expertise to develop transformative strategies, scale businesses, and implement innovative solutions in digital commerce. This certification is for professionals and managers in the e-commerce management field. As e-commerce continues to shape the global economy, organizations need forward-thinking professionals who can drive growth, enhance customer engagement, and deliver measurable results. The AC-ESGP\u{00ae} certification empowers you to be that leader.",
            ],
            'modules' => [
                'heading' => 'Program Highlights',
                'items'   => [
                    self::module('Holistic Curriculum',                'Covering strategy development, market growth tactics, technology integration, and ethical business practices.'),
                    self::module('Practical, Real-World Applications', 'Engage with case studies, interactive projects, and hands-on exercises for actionable learning.'),
                    self::module('Expert Instruction',                 'Learn from e-commerce leaders, strategists, and industry innovators with years of experience.'),
                    self::module('Global Recognition',                 'Earn a certification that validates your expertise and is respected by top organizations worldwide.'),
                    self::module('Networking Opportunities',           'Access a professional network of peers, mentors, and thought leaders in e-commerce.'),
                ],
            ],
            'training_header' => [
                'heading' => "AC-ESGP\u{00ae} Virtual/Online Instructor-led 4-day Training",
            ],
            'trainers' => [
                [
        ...
        Page::updateOrCreate(
            ['slug' => 'aapscm-training-virtual-american-certified-e-commerce-strategy-and-growth-professional-ac-esgp'],
            [
                'title'            => "Instructor-led virtual training - American Certified E-Commerce Strategy and Growth Professional (AC-ESGP)\u{00ae}",
                'content'          => null,
                'excerpt'          => "AAPSCM\u{00ae} 4-day virtual/online instructor-led training for the American Certified E-Commerce Strategy and Growth Professional (AC-ESGP)\u{00ae} certification. $1,200. Develop transformative strategies, scale businesses, and implement innovative solutions in digital commerce.",
                'status'           => 'published',
                'is_published'     => true,
                'template'         => 'standard_content',
                'page_data'        => $pageData,
                'meta_title'       => "Instructor-led virtual training - American Certified E-Commerce Strategy and Growth Professional (AC-ESGP)\u{00ae} - AAPSCM\u{00ae}",
                'meta_description' => "Enroll in the AAPSCM\u{00ae} 4-day virtual/online instructor-led AC-ESGP\u{00ae} training for $1,200. Live sessions led by industry experts; multiple 2026 / 2027 dates available.",
                'show_in_nav'      => false,
            ],
        );
    }
