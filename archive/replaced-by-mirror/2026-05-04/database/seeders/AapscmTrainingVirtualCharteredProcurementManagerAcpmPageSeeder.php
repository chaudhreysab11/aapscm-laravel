...
/**
 * Transcribes https://aapscm.org/aapscm-training-virtual-chartered-procurement-manager-acpm/
 *
 * Sections (canonical, desktop variant):
 *   hero              (title bar)
 *   why_cert          (image + heading + paragraph)
 *   topics            (heading + intro + 5 instructional-area items)
 *   training_header   (single heading — "CPM® Virtual/Online Instructor-led 4-day Training")
 ...
 *
 * Note: the live page has no standalone intro text section — section 1 is the
 * image+heading+body block that maps directly onto the why_cert schema.
 */
class AapscmTrainingVirtualCharteredProcurementManagerAcpmPageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $pageData = [
            'hero' => [
                'title' => "Chartered Procurement Manager (CPM)\u{00ae}",
            ],
            'why_cert' => [
                'image'   => UrlRewriter::image('https://aapscm.org/wp-content/uploads/2025/06/1.jpg'),
                'heading' => "Chartered Procurement Manager (CPM)\u{00ae}",
                'body'    => "The American Certified Procurement Manager (CPM\u{00ae}) tests knowledge and skills of a procurement manager. CPM examines project contracts and procurement processes and explores the stages of contracting and procurement in the project environment. The certification certifies your skills and techniques to develop a procurement plan, contract statement of work, contract evaluation criteria, request for proposals, and the processes of contract administration and closure.",
            ],
            'topics' => [
                'heading' => 'Topics and Description',
                'intro'   => 'The examination test members in major instructional areas in an advanced Procurement Management skills which include',
                'items'   => [
                    'Procurement management: 1)Planning of purchases and acquisitions 2) Bidding processes 3) Procurement decision analysis',
                    'Plan contracting: 1)Contract statement of work 2) Standard forms and templates 3) Evaluation criteria 4) Procurement management plan',
                    'Contract administration and change control: 1)Contract management plan 2) Communication and relationships 3) Ethics 4) Change management',
                    'Contract closure',
                    'Logistics',
                ],
            ],
            'training_header' => [
                'heading' => "CPM\u{00ae} Virtual/Online Instructor-led 4-day Training",
            ],
            'trainers' => [
                [
            ...
            'schedule' => [
                ...
                'options' => [
                    ...
                    'JULY 25-29, 2029 (+$1,200.00)',
                    'SEPT 1-4, 2029 (+$1,200.00)',
                    'SEPT 6-11, 2029 (+$1,200.00)',
                    'SEPT 15-19, 2029 (+$1,200.00)',
                    'SEPT 25-29, 2029 (+$1,200.00)',
                ],
        ...
        Page::updateOrCreate(
            ['slug' => 'aapscm-training-virtual-chartered-procurement-manager-acpm'],
            [
                'title'            => "Instructor-led virtual training - Chartered Procurement Manager (CPM)\u{00ae}",
                'content'          => null,
                'excerpt'          => "AAPSCM\u{00ae} 4-day virtual/online instructor-led training for the Chartered Procurement Manager (CPM)\u{00ae} certification. $1,200. Led by Gleb Mikulich, Dr. Jason Matyus and James Raussen.",
                'status'           => 'published',
                'is_published'     => true,
                'template'         => 'standard_content',
                'page_data'        => $pageData,
                'meta_title'       => "Instructor-led virtual training - Chartered Procurement Manager (CPM)\u{00ae} - AAPSCM\u{00ae}",
                'meta_description' => "Enroll in the AAPSCM\u{00ae} 4-day virtual/online instructor-led CPM\u{00ae} training for $1,200. Live sessions led by industry experts; multiple 2026 / 2027 / 2029 dates available.",
                'show_in_nav'      => false,
            ],
        );
    }
