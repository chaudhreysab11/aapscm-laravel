...
/**
 * Transcribes https://aapscm.org/aapscm-training-virtual-chartered-supply-chain-manager-acscm/
 *
 * Sections (canonical, desktop variant — sections 6+):
 *   hero              (title bar)
 *   intro             (heading + paragraph)
 *   topics            (heading + intro + 8 bullets + closing + image)
 *   training_header   ("CSCM® Virtual/Online Instructor-led 4-day Training")
 *   trainers          (3 tabbed trainer panes — Gleb, Dr. Jason, James)
 *   schedule          (date-picker dropdown)
 *
 * Note: no `why_cert` 2-col block on this page.
 */
class AapscmTrainingVirtualCharteredSupplyChainManagerAcscmPageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $pageData = [
            ...
            'topics' => [
                ...
                'items'   => [
                    ...
                    "Design e-procurement strategies for a firm\u{2019}s procurement portfolio of products and services.",
                ...
                'closing' => "The ACSCM\u{00ae} certification examination is the overall assessment of the understanding of the framework for SCM that requires cross-functional integration of key business processes within the firm and across the network of firms that comprise the supply chain.",
                'image'   => UrlRewriter::image('https://aapscm.org/wp-content/uploads/2025/06/img.png'),
            ],
            'training_header' => [
                'heading' => "CSCM\u{00ae} Virtual/Online Instructor-led 4-day Training",
            ],
            'trainers' => [
                [
        ...
        Page::updateOrCreate(
            ['slug' => 'aapscm-training-virtual-chartered-supply-chain-manager-acscm'],
            [
                'title'            => "Instructor-led virtual training - Chartered Supply Chain Manager (CSCM)\u{00ae}",
                'content'          => null,
                'excerpt'          => "AAPSCM\u{00ae} 4-day virtual/online instructor-led training for the Chartered Supply Chain Manager (CSCM)\u{00ae} certification. $1,200. Led by Gleb Mikulich, Dr. Jason Matyus and James Raussen.",
                'status'           => 'published',
                'is_published'     => true,
                'template'         => 'standard_content',
                'page_data'        => $pageData,
                'meta_title'       => "Instructor-led virtual training - Chartered Supply Chain Manager (CSCM)\u{00ae} - AAPSCM\u{00ae}",
                'meta_description' => "Enroll in the AAPSCM\u{00ae} 4-day virtual/online instructor-led CSCM\u{00ae} training for $1,200. Live sessions led by industry experts; multiple 2026 / 2027 / 2028 dates available.",
                'show_in_nav'      => false,
            ],
        );
    }
