...
/**
 * Transcribes https://aapscm.org/aapscm-training-virtual-american-certified-procurement-data-science-ai-specialist-ac-pdss/
 *
 * Layout: intro (About) → why_cert (image + What is) → topics (Why Choose 5 bullets + img)
 *         → training_header → trainers (3) → schedule (43 dates ending SEPT 2029)
 */
class AapscmTrainingVirtualAmericanCertifiedProcurementDataScienceAiSpecialistAcPdssPageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $pageData = [
            ...
            'intro' => [
                'heading' => "About AC-PDS\u{00ae}",
                'body'    => 'Welcome to the forefront of procurement transformation with the American Certified Procurement Data Science & AI Specialist (AC-PDSS) designation. This certification equips professionals with the skills to harness the power of data science and artificial intelligence (AI) to revolutionize procurement strategies, drive efficiency, and deliver unparalleled value in a competitive global landscape.',
            ],
            'why_cert' => [
                'image'   => UrlRewriter::image('https://aapscm.org/wp-content/uploads/2025/06/1.jpg'),
                'heading' => 'What is AC-PDS?',
                'body'    => 'The AC-PDSS Certification is designed for procurement professionals who want to leverage advanced data science and AI technologies. It focuses on integrating cutting-edge analytics, automation, and predictive capabilities into procurement processes to enhance decision-making, optimize supply chains, and achieve sustainable business outcomes.',
            ],
            'topics' => [
                'heading' => 'Why Choose AC-PDS?',
                'items'   => [
            ...
            'training_header' => [
                'heading' => "AC-PDS\u{00ae} Virtual/Online Instructor-led 4-day Training",
            ],
            'trainers' => [
                [
            ...
            'schedule' => [
                ...
                'options' => [
                    ...
                    'SEPT 1-4, 2029 (+$1,200.00)', 'SEPT 6-11, 2029 (+$1,200.00)', 'SEPT 15-19, 2029 (+$1,200.00)', 'SEPT 25-29, 2029 (+$1,200.00)',
                ],
        ...
        Page::updateOrCreate(
            ['slug' => 'aapscm-training-virtual-american-certified-procurement-data-science-ai-specialist-ac-pdss'],
            [
                'title'            => "Instructor-led virtual training - American Certified Procurement Data Science & AI Professional (AC-PDS)\u{00ae}",
                'content'          => null,
                'excerpt'          => "AAPSCM\u{00ae} 4-day virtual/online instructor-led training for the American Certified Procurement Data Science & AI Professional (AC-PDS)\u{00ae} certification. $1,200. Harness data science and AI to transform procurement strategy and decision-making.",
                'status'           => 'published',
                'is_published'     => true,
                'template'         => 'standard_content',
                'page_data'        => $pageData,
                'meta_title'       => "Instructor-led virtual training - American Certified Procurement Data Science & AI Professional (AC-PDS)\u{00ae} - AAPSCM\u{00ae}",
                'meta_description' => "Enroll in the AAPSCM\u{00ae} 4-day virtual/online instructor-led AC-PDS\u{00ae} training for $1,200. Live sessions led by industry experts; multiple 2026 / 2027 / 2029 dates available.",
                'show_in_nav'      => false,
            ],
        );
    }
