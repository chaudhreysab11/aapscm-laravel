...
/**
 * Transcribes https://aapscm.org/aapscm-training-virtual-american-certified-procurement-professional-acpp/
 *
 * Sections (canonical, desktop variant):
 *   hero              (title bar)
 *   intro             (heading + paragraph)
 *   why_cert          (image + heading + paragraph)
 *   topics            (heading + intro + 3 bullets + closing + image)
 *   training_header   (single heading — "ACPP® Virtual/Online Instructor-led 4-day Training")
 *   trainers          (3 tabbed trainer panes; each carries navy sidebar with
 *                      avatar + Time / Fees / Address and white bio + badges)
 *   schedule          (date-picker dropdown rendered from WooCommerce variable product)
 */
class AapscmTrainingVirtualAmericanCertifiedProcurementProfessionalAcppPageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $pageData = [
            'hero' => [
                'title' => "American Certified Procurement Professional (ACPP)\u{00ae}",
            ],
            'intro' => [
                'heading' => "The American Certified Professional in Procurement Management (ACPP\u{00ae})",
                'body'    => "The American Certified Professional in Procurement Management (ACPP\u{00ae}) certification shows future employers that you have the practical knowledge, insights, and professional expertise to meet increasingly heightened. Procurement management processes and ethics demands. ACPP\u{00ae} certification is a pre-requisite for ACPM\u{00ae} which is the standard certification for Managers in Procurement.",
            ],
            'why_cert' => [
                'image'   => UrlRewriter::image('https://aapscm.org/wp-content/uploads/2025/06/1.jpg'),
                'heading' => 'Why go for ACPP Certification?',
                'body'    => "ACPP\u{00ae} certification helps professionals acquire basic knowledge and skills of a procurement specialist. The ACPP\u{00ae} certification exam assumes that you have a close working relationship with the procurement process. It is assumed that the examination assesses your understanding of a formal process of obtaining goods and services Procurement Management Plan, Procurement Statement of Work (SOW), procurement documents, change requests, additional procurement documentation and lessons learned are the outputs of a Procurement Management Process.",
            ],
            'topics' => [
                'heading' => 'Topics and Description',
                'intro'   => "The examination provides an overview of procurement fundamentals, basic definitions and discover why procurement is important to the firm, sourcing strategies, supplier relationship management, negotiations, evaluation metrics, difference between \u{201C}Directs and Indirect\u{201D}, \"basic\" flow of procurement processes and more. You\u{2019}ll be better equipped to:",
                'items'   => [
            ...
            'training_header' => [
                'heading' => "ACPP\u{00ae} Virtual/Online Instructor-led 4-day Training",
            ],
            'trainers' => [
                [
            ...
            'schedule' => [
                ...
                'options' => [
                    ...
                    'JUL 25-29, 2026 (+$1,200.00)',
                    'AUG 1-4, 2026 (+$1,200.00)',
                    'AUG 6-10, 2026 (+$1,200.00)',
                    'AUG 15-19, 2026 (+$1,200.00)',
                    'AUG 25-29, 2026 (+$1,200.00)',
                    'SEP 1-4, 2026 (+$1,200.00)',
                    'SEP 6-11, 2026 (+$1,200.00)',
                    'SEP 15-19, 2026 (+$1,200.00)',
                    'SEP 25-29, 2026 (+$1,200.00)',
        ...
        Page::updateOrCreate(
            ['slug' => 'aapscm-training-virtual-american-certified-procurement-professional-acpp'],
            [
                'title'            => "Instructor-led virtual training - American Certified Procurement Professional (ACPP)\u{00ae}",
                'content'          => null,
                'excerpt'          => "AAPSCM\u{00ae} 4-day virtual/online instructor-led training for the American Certified Procurement Professional (ACPP)\u{00ae} certification. $1,200. Led by Gleb Mikulich, Dr. Jason Matyus and James Raussen.",
                'status'           => 'published',
                'is_published'     => true,
                'template'         => 'standard_content',
                'page_data'        => $pageData,
                'meta_title'       => "Instructor-led virtual training - American Certified Procurement Professional (ACPP)\u{00ae} - AAPSCM\u{00ae}",
                'meta_description' => "Enroll in the AAPSCM\u{00ae} 4-day virtual/online instructor-led ACPP\u{00ae} training for $1,200. Live sessions led by industry experts; multiple 2026 / 2027 dates available.",
                'show_in_nav'      => false,
            ],
        );
    }
