...
/**
 * Transcribes https://aapscm.org/aapscm-training-virtual-chartered-sustainable-supply-chain-manager-csscm/
 *
 * Layout: why_cert (2 paragraphs) → topics ("Why Choose CSSCM?" + 4 bullets + img)
 *         → modules ("What You'll Learn" 6 cards) → training_header → trainers (3) → schedule (43 dates).
 */
class AapscmTrainingVirtualCharteredSustainableSupplyChainManagerCsscmPageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $pageData = [
            'hero' => [
                'title' => "Chartered Sustainable Supply Chain Manager (CSSCM)\u{00ae}",
            ],
            'why_cert' => [
                'heading'         => "About CSSCM\u{00ae}",
                'body_paragraphs' => [
                    'Shape the Future with Sustainable Supply Chain Practices',
            ...
            'topics' => [
                'heading' => 'Why Choose CSSCM?',
                'intro'   => 'Sustainability is now a critical component of supply chain management. The CSSCM certification equips you to:',
                'items'   => [
                    'Reduce Carbon Footprints: LImplement strategies to lower emissions in logistics and operations.',
                    'Promote Circular Economy Practices: Optimize resource usage through recycling, reusing, and waste reduction.',
                    'Ensure Compliance: Align with global sustainability regulations and standards.',
                    'Drive Business Growth: Build competitive advantage through sustainable practices that appeal to customers and stakeholders.',
                ],
            ...
            'modules' => [
                ...
                'items'   => [
                    self::module('Sustainability Principles in Supply Chains', 'Understand the fundamentals of eco-friendly and circular supply chain practices.'),
                    self::module('Carbon Emission Reduction Strategies',       'Master tools to measure and minimize emissions across the supply chain.'),
                    self::module('Circular Economy Integration',               'Learn to design supply chains that prioritize reuse, recycling, and minimal waste generation.'),
                    self::module('Green Logistics',                            'Optimize transportation and warehousing for energy efficiency and environmental compliance.'),
                    self::module('Sustainable Procurement',                    'Explore ethical sourcing and supplier management strategies.'),
                    self::module('Regulatory Compliance',                      'Stay informed about laws and standards governing sustainable practices globally.'),
                ],
            ],
            'training_header' => [
                'heading' => "CSSCM\u{00ae} Virtual/Online Instructor-led 4-day Training",
            ],
            'trainers' => [
                [
        ...
        Page::updateOrCreate(
            ['slug' => 'aapscm-training-virtual-chartered-sustainable-supply-chain-manager-csscm'],
            [
                'title'            => "Instructor-led virtual training - Chartered Sustainable Supply Chain Manager (CSSCM)\u{00ae}",
                'content'          => null,
                'excerpt'          => "AAPSCM\u{00ae} 4-day virtual/online instructor-led training for the Chartered Sustainable Supply Chain Manager (CSSCM)\u{00ae} certification. $1,200. Lead green, ethical, and circular supply chain strategies that balance profitability with environmental responsibility.",
                'status'           => 'published',
                'is_published'     => true,
                'template'         => 'standard_content',
                'page_data'        => $pageData,
                'meta_title'       => "Instructor-led virtual training - Chartered Sustainable Supply Chain Manager (CSSCM)\u{00ae} - AAPSCM\u{00ae}",
                'meta_description' => "Enroll in the AAPSCM\u{00ae} 4-day virtual/online instructor-led CSSCM\u{00ae} training for $1,200. Live sessions led by industry experts; multiple 2026 / 2027 / 2028 dates available.",
                'show_in_nav'      => false,
            ],
        );
    }
