...
/**
 * Transcribes https://aapscm.org/aapscm-training-virtual-american-certified-supply-chain-digital-transformation-manager-ac-scdtm/
 */
class AapscmTrainingVirtualAmericanCertifiedSupplyChainDigitalTransformationManagerAcScdtmPageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $pageData = [
            'hero' => [
                'title' => "American Certified Supply Chain Digital Transformation Manager (AC-SCDTM)\u{00ae}",
            ],
            'intro' => [
                'heading' => "American Certified Supply Chain Digital Transformation Manager (AC-SCDTM)\u{00ae}",
            ...
            'why_cert' => [
                ...
                'heading' => 'Overview',
                'body'    => "The AmericanCertified Supply Chain Digital Transformation Manager (AC-SCDTM)\u{00ae} certification is a groundbreaking program designed by the American Association of Procurement, Supply Chain, and Tourism Management (AAPSCM\u{00ae})\u{00ae}to equip professionals with the skills to lead supply chain modernization through cutting-edge technology. With rapid advancements in AI, blockchain, IoT, and robotics, supply chain management is evolving into a highly interconnected digital ecosystem. This certification empowers professionals to leverage these technologies to enhance efficiency, resilience, and sustainability in global supply chains.",
            ],
            'modules' => [
                'heading' => 'Program Highlights',
                'items'   => [
                    self::module('Comprehensive Curriculum',         'Covering digital transformation strategies, emerging technologies, data-driven decision-making, and sustainable practices.'),
                    self::module('Real-World Applications',          'Practical exercises, simulations, and case studies to ensure hands-on learning.'),
                    self::module('Expert Faculty',                   'Learn from industry leaders with experience in supply chain technology and innovation.'),
                    self::module('Globally Recognized Credential:',  'A trusted credential for professionals driving digital transformation in supply chain management.'),
                    self::module('Future-Focused Content',           'Stay ahead of trends and innovations shaping the future of supply chains.'),
                ],
            ],
            'training_header' => [
                'heading' => "AC-SCDTM\u{00ae} Virtual/Online Instructor-led 4-day Training",
            ],
            'trainers' => [
                [
        ...
        Page::updateOrCreate(
            ['slug' => 'aapscm-training-virtual-american-certified-supply-chain-digital-transformation-manager-ac-scdtm'],
            [
                'title'            => "Instructor-led virtual training - American Certified Supply Chain Digital Transformation Manager (AC-SCDTM)\u{00ae}",
                'content'          => null,
                'excerpt'          => "AAPSCM\u{00ae} 4-day virtual/online instructor-led training for the American Certified Supply Chain Digital Transformation Manager (AC-SCDTM)\u{00ae} certification. $1,200. Lead supply chain modernization through AI, blockchain, IoT, and robotics.",
                'status'           => 'published',
                'is_published'     => true,
                'template'         => 'standard_content',
                'page_data'        => $pageData,
                'meta_title'       => "Instructor-led virtual training - American Certified Supply Chain Digital Transformation Manager (AC-SCDTM)\u{00ae} - AAPSCM\u{00ae}",
                'meta_description' => "Enroll in the AAPSCM\u{00ae} 4-day virtual/online instructor-led AC-SCDTM\u{00ae} training for $1,200. Live sessions led by industry experts; multiple 2026 / 2027 dates available.",
                'show_in_nav'      => false,
            ],
        );
    }
