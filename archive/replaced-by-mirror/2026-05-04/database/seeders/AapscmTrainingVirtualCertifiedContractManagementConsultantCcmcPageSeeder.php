...
/**
 * Transcribes https://aapscm.org/aapscm-training-virtual-certified-contract-management-consultant-ccmc/
 *
 * Sections (canonical, desktop variant):
 *   topics            (heading "Certification Overview" + intro + 5 bullets + closing + image)
 *   training_header   ("CCMC® Virtual/Online Instructor-led 4-day Training")
 *   trainers          (3 tabbed trainer panes — Gleb / Dr. Jason / James, with CCMC-specific avatars)
 *   schedule          (date-picker dropdown)
 */
class AapscmTrainingVirtualCertifiedContractManagementConsultantCcmcPageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $pageData = [
            'intro_band' => [
                'heading'    => 'Become a Trusted Contract Management Consultant',
                'subheading' => "Certified Contract Management Consultant (CCMC)\u{00ae}",
                'paragraphs' => [
                    'Lead transformation. Advise executives. Deliver measurable value.',
                    "Master contract strategy, governance, digital transformation, and AI-driven contract intelligence to position yourself as a top-tier consultant and advisor in today\u{2019}s complex global economy.",
                ],
                'badges' => [
                    'Elite-Level',
                    'Consulting-Focused',
                ...
                'footer' => 'Transform Organizations. Elevate Your Consulting Career.',
            ],
            'topics' => [
                'heading' => 'Certification Overview',
                'intro'   => "The Certified Contract Management Consultant (CCMC)\u{00ae} is an elite, advisory-level certification designed for experienced professionals who provide strategic consulting, advisory, audit, and transformation services in contract management.\n\nUnlike traditional certifications focused on execution, CCMC\u{00ae} is built for consultants, advisors, and senior leaders who are responsible for:",
                'items'   => [
                    'Diagnosing contract management challenges',
                    'Designing enterprise solutions',
                    'Implementing transformation initiatives',
                    'Advising executive leadership',
                    'Delivering measurable business outcomes',
                ],
                'closing' => 'The program integrates modern consulting methodologies, AI-powered contract intelligence, and digital transformation frameworks to ensure participants can operate effectively in high-value, complex environments.',
                'image'   => UrlRewriter::image('https://aapscm.org/wp-content/uploads/2026/04/1-478.png'),
            ],
            'why_matters' => [
                'image'   => UrlRewriter::image('https://aapscm.org/wp-content/uploads/2026/04/1-479.png'),
                'heading' => "Why CCMC\u{00ae} Matters in Today\u{2019}s Market",
                'intro'   => 'Organizations are increasingly turning to consultants to solve challenges such as:',
                'items_a' => [
                    'Contract inefficiencies and revenue leakage',
                    'Regulatory compliance and audit failures',
                    'Lack of contract governance and controls',
                    'Digital transformation gaps',
                    'Poor contract lifecycle visibility',
                ],
                'middle'  => "CCMC\u{00ae} prepares professionals to:",
                'items_b' => [
                    'Deliver high-impact consulting engagements',
                    'Lead enterprise contract transformation initiatives',
                    'Provide strategic advisory services to executives',
                    'Implement AI-driven contract solutions',
                ],
            ],
            'learning_outcomes' => [
                'cards' => [
                    [
                        'image'   => UrlRewriter::image('https://aapscm.org/wp-content/uploads/2026/04/1-460.png'),
                        'heading' => 'Certification Learning Outcomes',
                        'intro'   => "By completing CCMC\u{00ae}, you will be able to:",
                        'items'   => [
                            'Apply contract management consulting frameworks and methodologies',
                            'Conduct organizational contract maturity assessments',
                            'Develop and implement enterprise transformation roadmaps',
                            'Advise on governance, compliance, and regulatory frameworks',
                            'Leverage AI tools for contract analytics and optimization',
                            'Design risk-based advisory solutions',
                            'Lead client engagements and stakeholder alignment',
                            'Deliver measurable business value through consulting services',
                        ],
                    ],
                    [
                        'image'      => UrlRewriter::image('https://aapscm.org/wp-content/uploads/2026/04/1-461.png'),
                        'heading'    => 'Certification Testing Outcomes',
                        'subheading' => '(Skills & Competencies)',
                        'intro'      => 'Graduates will demonstrate:',
                        'items'      => [
                            'Contract consulting and advisory expertise',
                            'Enterprise assessment and maturity modeling',
                            'Strategic transformation planning',
                            'Risk and compliance advisory',
                            'AI-enabled contract analytics',
                            'Executive communication and reporting',
                            'Consulting project delivery and ROI measurement',
                        ],
                    ],
                    [
                        'image'   => UrlRewriter::image('https://aapscm.org/wp-content/uploads/2026/04/1-462.png'),
                        'heading' => 'Who Should Enroll?',
                        'intro'   => "The CCMC\u{00ae} certification is ideal for:",
                        'items'   => [
                            ...
                            'Government and Public Sector Advisors',
                        ],
                    ],
                ],
            ],
            'training_header' => [
                'heading' => "CCMC\u{00ae} Virtual/Online Instructor-led 4-day Training",
            ],
            'trainers' => [
                [
        ...
        Page::updateOrCreate(
            ['slug' => 'aapscm-training-virtual-certified-contract-management-consultant-ccmc'],
            [
                'title'            => "AAPSCM\u{00ae} Training Virtual - Certified Contract Management Consultant (CCMC)\u{00ae}",
                'content'          => null,
                'excerpt'          => "AAPSCM\u{00ae} 4-day virtual/online instructor-led training for the Certified Contract Management Consultant (CCMC)\u{00ae} certification. $1,200. Led by Gleb Mikulich, Dr. Jason Matyus and James Raussen.",
                'status'           => 'published',
                'is_published'     => true,
                'template'         => 'standard_content',
                'page_data'        => $pageData,
                'meta_title'       => "AAPSCM\u{00ae} Training Virtual - Certified Contract Management Consultant (CCMC)\u{00ae} - AAPSCM\u{00ae}",
                'meta_description' => "Enroll in the AAPSCM\u{00ae} 4-day virtual/online instructor-led CCMC\u{00ae} training for $1,200. Live sessions led by industry experts; multiple 2026 / 2027 dates available.",
                'show_in_nav'      => false,
            ],
        );
    }
