...
/**
 * Transcribes https://aapscm.org/aapscm-training-virtual-american-certified-it-procurement-digital-transformation-specialist-acipdts/
 *
 * Layout matches the AC-DPAS page: why_cert (single paragraph) + topics (Program Highlights bullets)
 * + modules grid (8 cards, no intro line on this page) + trainers + schedule.
 */
class AapscmTrainingVirtualAmericanCertifiedItProcurementDigitalTransformationSpecialistAcipdtsPageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $pageData = [
            ...
            'topics' => [
                ...
                'items'   => [
                    ...
                    'Cloud and Cybersecurity Procurement',
            ...
            'modules' => [
                ...
                'items'   => [
                    self::module('Introduction to IT Procurement in Digital Transformation', 'Explore the fundamentals of IT procurement and its role in supporting digital transformation strategies.'),
                    self::module('Understanding Software and Hardware Procurement',          'Learn the essentials of procuring software, hardware, and IT services, focusing on compatibility, scalability, and organizational fit .'),
                    self::module('Vendor Evaluation and Technology Selection',               'Develop criteria for evaluating IT vendors, assessing product quality, support, and long-term viability to ensure value.'),
                    self::module('Managing Software Licensing and SaaS Contracts',           'Gain expertise in software licensing models, SaaS subscriptions, and contract negotiations, focusing on compliance and cost-efficiency.'),
                    self::module('Cloud and Cybersecurity Procurement',                      'Learn to procure cloud solutions and cybersecurity tools, ensuring alignment with security standards and risk management practices.'),
                    self::module('Digital Transformation and Technology Strategy',           'Understand how to align technology procurement with digital transformation objectives, supporting organizational goals through strategic sourcing.'),
                    self::module('Risk Management in IT Procurement',                        'Develop skills to identify and mitigate risks associated with technology procurement, from vendor lock-in to cybersecurity threats.'),
                    self::module('Capstone Project: Building an IT Procurement Strategy for Digital Transformation', 'Apply your learning by creating a comprehensive IT procurement strategy for a sample organization, focusing on vendor selection, licensing, and digital transformation alignment.'),
                ],
            ],
            'training_header' => [
                'heading' => "ACIPDT\u{00ae} Virtual/Online Instructor-led 4-day Training",
            ],
            'trainers' => [
                [
            ...
            'schedule' => [
                ...
                'options' => [
                    ...
                    'JULY 25-29, 2028 (+$1,200.00)', 'SEPT 1-4, 2028 (+$1,200.00)', 'SEPT 6-11, 2028 (+$1,200.00)', 'SEPT 15-19, 2028 (+$1,200.00)', 'SEPT 25-29, 2028 (+$1,200.00)',
                ],
        ...
        Page::updateOrCreate(
            ['slug' => 'aapscm-training-virtual-american-certified-it-procurement-digital-transformation-specialist-acipdts'],
            [
                'title'            => "Instructor-led virtual training - American Certified IT Procurement & Digital Transformation Professional (ACIPDT)\u{00ae}",
                'content'          => null,
                'excerpt'          => "AAPSCM\u{00ae} 4-day virtual/online instructor-led training for the American Certified IT Procurement & Digital Transformation Professional (ACIPDT)\u{00ae} certification. $1,200. Covers software/IT procurement, vendor evaluation, SaaS contracts, cloud & cybersecurity, and digital transformation strategy.",
                'status'           => 'published',
                'is_published'     => true,
                'template'         => 'standard_content',
                'page_data'        => $pageData,
                'meta_title'       => "Instructor-led virtual training - American Certified IT Procurement & Digital Transformation Professional (ACIPDT)\u{00ae} - AAPSCM\u{00ae}",
                'meta_description' => "Enroll in the AAPSCM\u{00ae} 4-day virtual/online instructor-led ACIPDT\u{00ae} training for $1,200. Live sessions led by industry experts; multiple 2026 / 2027 / 2028 dates available.",
                'show_in_nav'      => false,
            ],
        );
    }
