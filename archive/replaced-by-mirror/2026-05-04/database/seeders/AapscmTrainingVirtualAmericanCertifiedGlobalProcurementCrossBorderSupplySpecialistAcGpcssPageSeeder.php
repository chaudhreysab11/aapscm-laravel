...
/**
 * Transcribes https://aapscm.org/aapscm-training-virtual-american-certified-global-procurement-cross-border-supply-specialist-ac-gpcss/
 *
 * Layout: why_cert (image + paragraph), topics (7 bullets + img), modules (10 cards),
 * training_header, trainers (3), schedule (42 dates — note no MAY 22-26).
 */
class AapscmTrainingVirtualAmericanCertifiedGlobalProcurementCrossBorderSupplySpecialistAcGpcssPageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $pageData = [
            ...
            'modules' => [
                ...
                'items'   => [
                    self::module('Introduction to Global Procurement and Cross-Border Supply Chains', 'Explore the complexities and benefits of international procurement and global supply chains.'),
                    self::module('International Trade Regulations and Compliance',                    'Learn about trade regulations, tariffs, import/export laws, and trade agreements that affect global sourcing.'),
                    self::module('Cross-Cultural Communication and Negotiation',                      'Develop skills for effective communication and negotiation across different cultural environments, focusing on collaboration and mutual understanding'),
                    self::module('Logistics and Transportation Management',                           'Understand the logistics of cross-border procurement, including freight options, customs processes, and inventory management for global operations.'),
                    self::module('Global Supplier Evaluation and Risk Assessment',                    'Establish criteria for selecting and evaluating international suppliers, focusing on compliance, reliability, and risk mitigation.'),
                    self::module('Customs and Duty Management',                                       'Gain expertise in managing customs processes and duties, understanding their impact on global procurement costs and delivery times.'),
                    self::module('Managing Currency and Economic Risks',                              'Learn how to navigate currency fluctuations, economic instability, and their impact on cross-border procurement.'),
                    self::module('Sustainable and Ethical Sourcing in Global Supply Chains',          'Explore the importance of sustainable and ethical sourcing practices when managing international suppliers, ensuring alignment with ESG principles.'),
                    self::module('Capstone Project: Designing a Global Procurement Strategy',         'Apply your knowledge by developing a global procurement strategy for a multinational organization, addressing key aspects such as supplier selection, compliance, risk management, and logistics.'),
                    self::module('Case Studies in Global Procurement',                                'Analyze real-world examples of successful and challenging global procurement projects to gain insights into best practices and lessons learned.'),
                ],
            ],
            'training_header' => [
                'heading' => "AC-GPCS\u{00ae} Virtual/Online Instructor-led 4-day Training",
            ],
            'trainers' => [
                [
            ...
            'schedule' => [
                ...
                'options' => [
                    ...
                    'MAY 1-4, 2026 (+$1,200.00)', 'MAY 15-19, 2026 (+$1,200.00)',
        ...
        Page::updateOrCreate(
            ['slug' => 'aapscm-training-virtual-american-certified-global-procurement-cross-border-supply-specialist-ac-gpcss'],
            [
                'title'            => "Instructor-led virtual training - American Certified Global Procurement & Cross-Border Supply Professional (AC-GPCS)\u{00ae}",
                'content'          => null,
                'excerpt'          => "AAPSCM\u{00ae} 4-day virtual/online instructor-led training for the American Certified Global Procurement & Cross-Border Supply Professional (AC-GPCS)\u{00ae} certification. $1,200. Covers international trade regulations, cross-cultural negotiation, logistics, customs and global supplier risk.",
                'status'           => 'published',
                'is_published'     => true,
                'template'         => 'standard_content',
                'page_data'        => $pageData,
                'meta_title'       => "Instructor-led virtual training - American Certified Global Procurement & Cross-Border Supply Professional (AC-GPCS)\u{00ae} - AAPSCM\u{00ae}",
                'meta_description' => "Enroll in the AAPSCM\u{00ae} 4-day virtual/online instructor-led AC-GPCS\u{00ae} training for $1,200. Live sessions led by industry experts; multiple 2026 / 2027 / 2028 dates available.",
                'show_in_nav'      => false,
            ],
        );
    }
