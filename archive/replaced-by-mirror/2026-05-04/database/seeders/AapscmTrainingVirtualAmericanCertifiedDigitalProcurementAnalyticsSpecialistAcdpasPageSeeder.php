...
/**
 * Transcribes https://aapscm.org/aapscm-training-virtual-american-certified-digital-procurement-analytics-specialist-acdpas/
 *
 * Page-specific structural notes (vs. ACPP reference):
 *   - No centered intro section (omit `intro` key).
 *   - `why_cert` carries the "About AC-DPA®" 2-col block; body is 3 paragraphs (use `body_paragraphs`).
 *   - `topics` carries the "Program Highlights" 5-bullet block.
 *   - New `modules` section: "Program Structure and Modules" + 8 cards.
 *   - Trainers, schedule: identical to ACTP (3 trainers, 43 dates).
 */
class AapscmTrainingVirtualAmericanCertifiedDigitalProcurementAnalyticsSpecialistAcdpasPageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $pageData = [
            ...
            'modules' => [
                ...
                'intro'   => 'This comprehensive program spans 4-day training (2 hours daily) and includes the following modules:',
                'items'   => [
                    self::module('Introduction to Digital Procurement',     'Understand the essentials of digital procurement, current trends, and the transformative potential of digital tools.'),
                    self::module('Data Collection and Management',          'Dive into data management, focusing on data collection, cleansing, and preparation for accurate analysis in procurement.'),
                    self::module('Analytics in Procurement',                'Learn techniques in data analysis, including data mining, dashboard creation, and KPI tracking for effective procurement.'),
                    self::module('AI and Machine Learning in Supply Chain', 'Explore practical applications of AI and ML, such as demand forecasting, anomaly detection, and automated supplier selection.'),
                    self::module('Blockchain and Transparency',             'Discover how blockchain enhances supply chain transparency and security, improving trust across partners and stakeholders.'),
                    self::module('Predictive and Prescriptive Analytics',   'Develop skills in advanced analytics to forecast supply chain needs, optimize decision-making, and improve procurement performance.'),
                    self::module('Digital Tools and Platforms',             'Gain hands-on experience with top digital procurement platforms and tools like SAP Ariba, Oracle Procurement Cloud, and Coupa.'),
                    self::module('Capstone Project',                        'Apply your new skills in a real-world scenario, analyzing data and developing a strategy for digital procurement optimization.'),
                ],
            ],
            'training_header' => [
                'heading' => "AC-DPA\u{00ae} Virtual/Online Instructor-led 4-day Training",
            ],
            'trainers' => [
                [
        ...
        Page::updateOrCreate(
            ['slug' => 'aapscm-training-virtual-american-certified-digital-procurement-analytics-specialist-acdpas'],
            [
                'title'            => "Instructor-led virtual training - American Certified Digital Procurement & Analytics Professional (AC-DPA)\u{00ae}",
                'content'          => null,
                'excerpt'          => "AAPSCM\u{00ae} 4-day virtual/online instructor-led training for the American Certified Digital Procurement-Analytics Professional (AC-DPA)\u{00ae} certification. $1,200. Covers digital procurement, analytics, AI/ML, blockchain and predictive analytics.",
                'status'           => 'published',
                'is_published'     => true,
                'template'         => 'standard_content',
                'page_data'        => $pageData,
                'meta_title'       => "Instructor-led virtual training - American Certified Digital Procurement & Analytics Professional (AC-DPA)\u{00ae} - AAPSCM\u{00ae}",
                'meta_description' => "Enroll in the AAPSCM\u{00ae} 4-day virtual/online instructor-led AC-DPA\u{00ae} training for $1,200. Live sessions led by industry experts; multiple 2026 / 2027 / 2028 dates available.",
                'show_in_nav'      => false,
            ],
        );
    }
