...
/**
 * Transcribes https://aapscm.org/aapscm-training-virtual-american-certified-blockchain-for-supply-chain-professional-ac-bscp/
 *
 * Layout: why_cert (2 paragraphs) → topics ("Why Choose AC-BSCP?" + 4 bullets + img)
 *         → modules ("What You'll Learn" 6 cards) → training_header → trainers (3) → schedule (43 dates).
 */
class AapscmTrainingVirtualAmericanCertifiedBlockchainForSupplyChainProfessionalAcBscpPageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $pageData = [
            'hero' => [
                'title' => "American Certified Blockchain for Supply Chain Professional (AC-BSCP)\u{00ae}",
            ],
            'why_cert' => [
                'heading'         => "About AC-BSCP\u{00ae}",
                'body_paragraphs' => [
                    'Secure, Transparent, and Efficient Supply Chains with Blockchain',
                    'The Blockchain for Supply Chain Professional Certification (AC-BSCP) is designed for individuals and organizations ready to revolutionize supply chain operations using the transformative power of blockchain. This program equips you with the knowledge and skills to harness blockchain technology for transparency, security, and efficiency in supply chains.',
                ],
            ],
            'topics' => [
                ...
                'items'   => [
                    'Enhance Traceability: Track goods from origin to delivery with immutable blockchain records.',
                    'Improve Security: Safeguard supply chain data from tampering and unauthorized access.',
                    'Streamline Operations:Automate processes using smart contracts for faster and error-free transactions.',
                    'Boost Sustainability: Monitor and verify eco-friendly practices across the supply chain.',
                ],
            ...
            'modules' => [
                ...
                'items'   => [
                    self::module('Blockchain Fundamentals in Supply Chains', 'Understand the core principles of blockchain technology and its unique advantages.'),
                    self::module('Smart Contracts',                          'Learn to automate procurement and logistics with blockchain-based smart contracts.'),
                    self::module('Data Security and Privacy',                'Explore how blockchain ensures secure and transparent data sharing among stakeholders.'),
                    self::module('Traceability and Authenticity',            'Implement blockchain solutions to verify the origin and authenticity of goods.'),
                    self::module('Integration with IoT and AI',              'Discover how to combine blockchain with IoT devices and AI for real-time supply chain monitoring.'),
                    self::module('Compliance and Regulations',               'Master blockchain applications that adhere to global supply chain standards and laws.'),
                ],
            ],
            'training_header' => [
                'heading' => "AC-BSCP\u{00ae} Virtual/Online Instructor-led 4-day Training",
            ],
            'trainers' => [
                [
        ...
        Page::updateOrCreate(
            ['slug' => 'aapscm-training-virtual-american-certified-blockchain-for-supply-chain-professional-ac-bscp'],
            [
                'title'            => "Instructor-led virtual training - American Certified Blockchain for Supply Chain Professional (AC-BSCP)\u{00ae}",
                'content'          => null,
                'excerpt'          => "AAPSCM\u{00ae} 4-day virtual/online instructor-led training for the American Certified Blockchain for Supply Chain Professional (AC-BSCP)\u{00ae} certification. $1,200. Harness blockchain for transparency, security, and efficiency in supply chains.",
                'status'           => 'published',
                'is_published'     => true,
                'template'         => 'standard_content',
                'page_data'        => $pageData,
                'meta_title'       => "Instructor-led virtual training - American Certified Blockchain for Supply Chain Professional (AC-BSCP)\u{00ae} - AAPSCM\u{00ae}",
                'meta_description' => "Enroll in the AAPSCM\u{00ae} 4-day virtual/online instructor-led AC-BSCP\u{00ae} training for $1,200. Live sessions led by industry experts; multiple 2026 / 2027 / 2028 dates available.",
                'show_in_nav'      => false,
            ],
        );
    }
