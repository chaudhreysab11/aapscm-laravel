...
class ECommerceCertificationsPageSeeder extends Seeder
{
    public function run(): void
    {
        $pageData = require database_path('seeders/data/e-commerce-certifications_data.php');

        $this->rewriteUrls($pageData);

        Page::updateOrCreate(
            ['slug' => 'e-commerce-certifications'],
            [
                'title'            => 'E-commerce Certifications',
                'excerpt'          => 'Globally recognised AAPSCM® E-commerce certifications for administration and management professionals — covering strategy, growth, AI-driven analytics, cross-border commerce, ethical and sustainable practices, and digital merchandising.',
                'status'           => 'published',
                'is_published'     => true,
