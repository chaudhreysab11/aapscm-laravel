<x-layouts.cms>
    ...
    {{-- Audience: Who Should Enroll / Ideal For --}}
    @if (! empty($d['audience']))
        ...
        <section class="bg-[#f5f7fa] py-16 md:py-20">
            <div class="max-w-[1200px] mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        @foreach ($d['exam_details']['items'] as $li)
                            <li class="flex gap-3">
                                <span class="text-[#5cb85c] font-bold mt-[2px]">&#10003;</span>
                                <span class="text-[15px] md:text-[16px] text-gray-700 leading-relaxed">{{ $li }}</span>
                            </li>
    ...
    @if (! empty($d['differentiators']))
        <section class="bg-white py-16 md:py-20">
            <div class="max-w-[1200px] mx-auto px-4">
                <h2 class="text-[26px] md:text-[32px] font-bold text-[#14166e] uppercase leading-snug text-center mb-12">{{ $d['differentiators']['heading'] }}</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                @if (! empty($d['differentiators']['closing']))
                    <p class="max-w-[1000px] mx-auto text-[15px] md:text-[16px] text-gray-700 text-center leading-relaxed mt-12 italic">{{ $d['differentiators']['closing'] }}</p>
                @endif
            </div>
        </section>
    @endif
